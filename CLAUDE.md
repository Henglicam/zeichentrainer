...
## Current state (PWA v44, 2026-09-02)
...
6. **After saving:** the note under the photo says what was saved and where the meaning came from. `QSCARD[id]` remembers the card; if the AI answers later, the jade suggestion box with **Accept / Dismiss** appears right there.
