...
- **v654–v655** — **Edit on the Learn card** inside Whole card (H: "not too prominent"); back to the same card, the pad kept unless the characters changed. Since v655 a grey toolbar of drawn icons over labels (H chose B of three mock-ups), since v658 only **Edit** — the marks sit on the photo like a Cards tile's: the star in the top-right corner, the flag beside it (H: "Doppelt gemoppelt ist zu vermeiden", "Unlogisch", then chose "marks on the photo"); a clean card is flagged through Edit.
