...
"Updated.":"Aktualisiert.",
  ...
  "{0} cards from this photo, {1} learned.":"{0} Karten von diesem Foto, {1} sicher.","{0} texts on this page, {1} learned.":"{0} Texte auf dieser Seite, {1} sicher.",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"Ein Foto mit mehreren Texten – ein App-Bildschirm, ein Bedienfeld, eine Speisekarte – wird zu einer Karte für das ganze Bild: eine Kachel unter Karten, tipp einen Text an, um ihn nachzuschlagen, und Lernen geht seine Texte einen nach dem anderen durch.","Tap any text on the photo.":"Tippe auf einen Text im Foto.",
  ...
  "Make this a flashcard":"Daraus eine Karte machen",
  "Already a flashcard":"Schon eine Karte",
  "From a multicard":"Aus einer Multicard",
  "From {0} multicards":"Aus {0} Multicards",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"Tippe auf einen Text in einer Multicard, um daraus eine Karte zu machen. Ein Text, der auf zwei Multicards steht oder den du dreimal nachschlägst, wird von selbst zu einer — und Lernen übt diese Karten, nie die Multicard selbst.",
  "Language":"Sprache",
...
"Updated.":"Mis à jour.",
  ...
  "{0} cards from this photo, {1} learned.":"{0} cartes sur cette photo, {1} acquises.","{0} texts on this page, {1} learned.":"{0} textes sur cette page, {1} acquis.",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"Une photo avec plusieurs textes — un écran d'appli, un panneau de commande, un menu — devient une seule carte pour toute l'image : une vignette sous Cartes, touche un texte pour le consulter, et Apprendre passe ses textes un par un.","Tap any text on the photo.":"Touche un texte sur la photo.",
  ...
  "Make this a flashcard":"En faire une carte",
  "Already a flashcard":"Déjà une carte",
  "From a multicard":"D'une multicarte",
  "From {0} multicards":"De {0} multicartes",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"Touche un texte d'une multicarte pour en faire une carte. Un texte qui apparaît sur deux multicartes, ou que tu consultes trois fois, le devient tout seul — et Apprendre travaille ces cartes-là, jamais la multicarte elle-même.",
  "Language":"Langue",
...
"Updated.":"Actualizado.",
  ...
  "{0} cards from this photo, {1} learned.":"{0} tarjetas de esta foto, {1} dominadas.","{0} texts on this page, {1} learned.":"{0} textos en esta página, {1} dominados.",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"Una foto con varios textos — una pantalla de app, un panel de mandos, una carta de menú — se convierte en una sola tarjeta para toda la imagen: una miniatura en Tarjetas, toca un texto para consultarlo, y Aprender repasa sus textos uno por uno.","Tap any text on the photo.":"Toca cualquier texto de la foto.",
  ...
  "Make this a flashcard":"Convertirlo en tarjeta",
  "Already a flashcard":"Ya es una tarjeta",
  "From a multicard":"De una multitarjeta",
  "From {0} multicards":"De {0} multitarjetas",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"Toca un texto de una multitarjeta para convertirlo en tarjeta. Un texto que aparece en dos multitarjetas, o que consultas tres veces, se convierte solo — y Aprender practica esas tarjetas, nunca la multitarjeta.",
  "Language":"Idioma",
...
"Updated.":"アップデートしました。",
  ...
  "{0} cards from this photo, {1} learned.":"この写真からカード{0}枚、うち{1}枚は習得済み。","{0} texts on this page, {1} learned.":"このページのテキスト{0}件、うち{1}件は習得済み。",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"テキストが複数ある写真 — アプリの画面、操作パネル、メニュー — は、画像全体で1枚のカードになります。カード一覧では1つのタイル、テキストをタップすれば調べられて、学習ではそのテキストを一つずつ出します。","Tap any text on the photo.":"写真の文字をタップしてみましょう。",
  ...
  "Make this a flashcard":"このテキストをカードにする",
  "Already a flashcard":"カードになっています",
  "From a multicard":"マルチカードから",
  "From {0} multicards":"{0}枚のマルチカードから",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"マルチカードの文字をタップすると、そこからカードを作れます。2枚のマルチカードに出てくる文字や、3回調べた文字は自動でカードになります。学習で出てくるのはそのカードで、マルチカード自体は出てきません。",
  "Language":"言語",
...
"Updated.":"업데이트했어요.",
  ...
  "{0} cards from this photo, {1} learned.":"이 사진에서 카드 {0}장, 그중 {1}장은 익힘.","{0} texts on this page, {1} learned.":"이 페이지의 텍스트 {0}개, 그중 {1}개는 익힘.",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"텍스트가 여러 개인 사진 — 앱 화면, 조작판, 메뉴판 — 은 사진 전체가 카드 한 장이 돼요. 카드 목록에는 타일 하나로 들어가고, 텍스트를 탭하면 찾아볼 수 있고, 학습에서는 그 텍스트를 하나씩 봐요.","Tap any text on the photo.":"사진 속 글자를 눌러 봐요.",
  ...
  "Make this a flashcard":"이 텍스트를 카드로 만들기",
  "Already a flashcard":"이미 카드예요",
  "From a multicard":"멀티카드에서",
  "From {0} multicards":"멀티카드 {0}개에서",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"멀티카드의 텍스트를 누르면 카드로 만들 수 있어요. 멀티카드 두 개에 나오는 텍스트나 세 번 찾아본 텍스트는 저절로 카드가 돼요. 학습에서는 그 카드가 나오고 멀티카드 자체는 나오지 않아요.",
  "Language":"언어",
...
"Updated.":"Обновлено.",
  ...
  "{0} cards from this photo, {1} learned.":"Карточек с этого фото: {0}, освоено: {1}.","{0} texts on this page, {1} learned.":"Текстов на этой странице: {0}, освоено: {1}.",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"Фото с несколькими текстами — экран приложения, панель управления, меню — становится одной карточкой на всё изображение: одна плитка в Карточках, нажми на любой текст, чтобы посмотреть его, а Учить проходит его тексты по одному.","Tap any text on the photo.":"Нажми на любой текст на фото.",
  ...
  "Make this a flashcard":"Сделать карточку",
  "Already a flashcard":"Уже карточка",
  "From a multicard":"Из мультикарточки",
  "From {0} multicards":"Из {0} мультикарточек",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"Нажми на текст в мультикарточке, чтобы сделать из него карточку. Текст, который встречается на двух мультикарточках или который ты посмотрел три раза, станет карточкой сам. «Учить» показывает именно эти карточки, а не саму мультикарточку.",
  "Language":"Язык",
...
"Updated.":"Đã cập nhật.",
  ...
  "{0} cards from this photo, {1} learned.":"{0} thẻ từ ảnh này, {1} đã thuộc.","{0} texts on this page, {1} learned.":"{0} đoạn chữ trên trang này, {1} đã thuộc.",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"Ảnh có nhiều đoạn chữ — màn hình ứng dụng, bảng điều khiển, thực đơn — thành một thẻ cho cả ảnh: một ô trong Thẻ, chạm vào đoạn chữ bất kỳ để tra, và Học sẽ lần lượt đi qua từng đoạn chữ của nó.","Tap any text on the photo.":"Chạm vào chữ bất kỳ trên ảnh.",
  ...
  "Make this a flashcard":"Tạo thẻ từ chữ này",
  "Already a flashcard":"Đã là một thẻ",
  "From a multicard":"Từ một thẻ gộp",
  "From {0} multicards":"Từ {0} thẻ gộp",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"Chạm vào một chữ trên thẻ gộp để biến nó thành thẻ. Chữ xuất hiện trên hai thẻ gộp, hoặc bạn tra ba lần, sẽ tự thành thẻ — và Học chỉ ôn những thẻ đó, không phải chính thẻ gộp.",
  "Language":"Ngôn ngữ",
...
"Updated.":"อัปเดตแล้ว",
  ...
  "{0} cards from this photo, {1} learned.":"การ์ด {0} ใบ จากรูปนี้ จำได้แล้ว {1} ใบ","{0} texts on this page, {1} learned.":"ข้อความ {0} จุดในหน้านี้ จำได้แล้ว {1}",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"รูปที่มีข้อความหลายจุด — หน้าจอแอป แผงควบคุม เมนู — จะกลายเป็นการ์ดใบเดียวสำหรับทั้งรูป เป็นหนึ่งช่องในการ์ด แตะข้อความจุดไหนก็ดูได้ และการเรียนจะพาไปทีละข้อความ","Tap any text on the photo.":"แตะข้อความบนรูปได้เลย",
  ...
  "Make this a flashcard":"ทำเป็นการ์ด",
  "Already a flashcard":"เป็นการ์ดแล้ว",
  "From a multicard":"จากการ์ดรวม",
  "From {0} multicards":"จากการ์ดรวม {0} ใบ",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"แตะข้อความบนการ์ดรวมเพื่อทำเป็นการ์ด ข้อความที่อยู่บนการ์ดรวมสองใบ หรือที่เปิดดูสามครั้ง จะกลายเป็นการ์ดเอง และโหมดเรียนจะฝึกการ์ดพวกนี้ ไม่ใช่การ์ดรวมเอง",
  "Language":"ภาษา",
...
"Updated.":"Diperbarui.",
  ...
  "{0} cards from this photo, {1} learned.":"{0} kartu dari foto ini, {1} sudah dikuasai.","{0} texts on this page, {1} learned.":"{0} teks di halaman ini, {1} sudah dikuasai.",
  ...
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture: one tile under Cards, tap any text on it to look it up, and Learn goes through its texts one by one.":"Foto dengan beberapa teks — layar aplikasi, panel kontrol, daftar menu — menjadi satu kartu untuk seluruh gambar: satu petak di Kartu, ketuk teks mana pun untuk melihatnya, dan Belajar melewati teksnya satu per satu.","Tap any text on the photo.":"Ketuk teks mana pun di foto.",
  ...
  "Make this a flashcard":"Jadikan kartu",
  "Already a flashcard":"Sudah jadi kartu",
  "From a multicard":"Dari satu multikartu",
  "From {0} multicards":"Dari {0} multikartu",
  "Tap a text on a multicard to turn it into a flashcard. A text you meet on two multicards, or look up three times, becomes one by itself — and Learn studies those, never the multicard itself.":"Ketuk teks di multikartu untuk menjadikannya kartu. Teks yang muncul di dua multikartu, atau yang kamu buka tiga kali, jadi kartu dengan sendirinya — dan Belajar melatih kartu-kartu itu, bukan multikartunya.",
  "Language":"Bahasa",
