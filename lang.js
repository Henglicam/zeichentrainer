...
"Updated.":"Aktualisiert.",
  ...
  "List":"Liste",
  "Tiles":"Kacheln",
  "Show {0} that already made cards":"{0}, die schon Karten ergeben haben, zeigen",
  ...
  "{0} cards from this photo, {1} known.":"{0} Karten von diesem Foto, {1} sicher.","{0} texts on this page, {1} known.":"{0} Texte auf dieser Seite, {1} sicher.",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Ein Foto, aus dem mehrere Karten wurden, zeigt an jedem Text einen Punkt — tipp einen an für Zeichen, Pinyin und Bedeutung, und bewerte ihn gleich dort.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"Ein Foto mit mehreren Texten – ein App-Bildschirm, ein Bedienfeld, eine Speisekarte – wird zu einer Karte für das ganze Bild mit einem Punkt an jedem Text: eine Zeile unter Karten, und Lernen geht seine Texte einen nach dem anderen durch.",
  ...
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"Die KI war nicht erreichbar, und das Lesen allein war zu unsicher für eine Karte. Tipp auf Ausschnitt, um das Foto noch mal zu lesen.",
  ...
  ", or the photo for the text alone":", oder auf das Foto für den Text allein","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"Eine Karte von einem Bildschirm oder einem Bedienfeld zeigt das ganze Bild mit einem Punkt an jedem Text, ihr eigener leuchtet, und sagt, die wievielte sie ist – 1 von 4; ein Tipp aufs Foto zeigt den Text allein.","Traditional":"Langzeichen","Simplified":"Kurzzeichen","Nothing could be read.":"Es konnte nichts gelesen werden.","Reading the text …":"Text wird gelesen …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Wisch die geschlossene Karte nach links oder rechts, um eine andere zu wählen — bewertet wird dabei nichts, und eine übersprungene Karte bleibt fällig und kommt beim nächsten Mal.",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Bewerte dich selbst: Schwer, Mittel, Leicht. Die Karte kommt früher oder später wieder, das ist der ganze Trick. Nichts fällig? Zieh die nächsten Karten vor.",
  "All your cards, newest first. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Alle deine Karten, neueste zuerst. Durchsuche sie, filtere nach Markierung oder Tag, tipp eine an für die Detailansicht mit Testen, Bearbeiten und Löschen. + Neu legt eine Karte von Hand an, gezeichnetes Zeichen inklusive. Schieb eine offene Karte zur Seite, dann kommt die nächste aus der Liste.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Tags gruppieren Karten für einen Kurs oder ein Niveau, und eine Karte aus einem Foto bekommt eins dafür, was sie ist — Speisekarte, Laden, Produkt, Gerät und so weiter; unter Mehr → Lernen gibt „Alle Karten taggen“ auch den älteren Karten eins. Lernen zeigt die Tags, die du wählst. Halte eine Karte gedrückt, um mehrere zu markieren und zusammen zu löschen — ein Foto im Kamera-Tab genauso. Tippe auf den Stern einer Karte, um sie dir zu merken — der Filter zeigt dann nur deine Karten mit Stern, und beim Lernen kommen alle dran, fällig oder nicht.",
...
"Updated.":"Mis à jour.",
  ...
  "List":"Liste",
  "Tiles":"Vignettes",
  "Show {0} that already made cards":"Afficher {0} qui ont déjà donné des cartes",
  "Hide them":"Masquer",
  "Crop":"Cadrer",
  ...
  "{0} cards from this photo, {1} known.":"{0} cartes sur cette photo, {1} acquises.","{0} texts on this page, {1} known.":"{0} textes sur cette page, {1} acquis.",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Une photo qui a donné plusieurs cartes montre un point sur chaque texte — touche-en un pour ses caractères, son pinyin et son sens, et note-le sur place.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"Une photo avec plusieurs textes — un écran d'appli, un panneau de commande, un menu — devient une seule carte pour toute l'image, avec un point sur chaque texte : une ligne sous Cartes, et Apprendre passe ses textes un par un.",
  ...
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"L'IA était injoignable, et la lecture seule était trop incertaine pour une carte. Touche Cadrer pour relire la photo.",
  ...
  ", or the photo for the text alone":", ou la photo pour le texte seul","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"Une carte issue d'un écran ou d'un panneau montre l'image entière avec un point sur chaque texte, le sien allumé, et dit laquelle c'est — 1 sur 4 ; un tap sur la photo montre le texte seul.","Traditional":"Traditionnel","Simplified":"Simplifié","Nothing could be read.":"Rien n'a pu être lu.","Reading the text …":"Lecture du texte …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Balaie la carte fermée vers la gauche ou la droite pour en choisir une autre — rien n'est noté, et une carte sautée reste à revoir la prochaine fois.",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Note-toi : Difficile, Moyen, Facile. La carte revient plus ou moins tôt, c'est toute l'astuce. Rien à revoir ? Avance les prochaines cartes.",
  "All your cards, newest first. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Toutes tes cartes, les plus récentes d'abord. Cherche, filtre par signalement ou tag, touche-en une pour son détail avec Tester, Modifier et Supprimer. + Nouvelle crée une carte à la main, caractère dessiné compris. Pousse une carte ouverte sur le côté pour passer à la suivante de la liste.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Les tags regroupent les cartes pour un cours ou un niveau, et une carte issue d'une photo en reçoit un pour ce qu'elle est — Menu, Boutique, Produit, Appareil, etc. ; dans Plus → Apprendre, « Taguer toutes les cartes » en donne un aussi aux anciennes. Apprendre montre les tags que tu choisis. Appuie longuement sur une carte pour en marquer plusieurs et les supprimer ensemble — pareil pour une photo dans l'onglet Appareil photo. Touche l'étoile d'une carte pour la garder à l'œil — le filtre n'affiche alors que tes cartes avec étoile, et Apprendre les prend toutes, dues ou non.",
...
"Updated.":"Actualizado.",
  ...
  "List":"Lista",
  "Tiles":"Mosaico",
  "Show {0} that already made cards":"Mostrar {0} que ya dieron tarjetas",
  "Hide them":"Ocultar",
  "Crop":"Recortar",
  ...
  "{0} cards from this photo, {1} known.":"{0} tarjetas de esta foto, {1} dominadas.","{0} texts on this page, {1} known.":"{0} textos en esta página, {1} dominados.",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Una foto de la que salieron varias tarjetas muestra un punto en cada texto — toca uno para ver sus caracteres, pinyin y significado, y califícalo ahí mismo.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"Una foto con varios textos — una pantalla de app, un panel de mandos, una carta de menú — se convierte en una sola tarjeta para toda la imagen, con un punto en cada texto: una fila en Tarjetas, y Aprender repasa sus textos uno por uno.",
  ...
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"No se pudo contactar con la IA, y la lectura sola era demasiado insegura para una tarjeta. Toca Recortar para leer la foto otra vez.",
  ...
  ", or the photo for the text alone":", o la foto para ver solo el texto","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"Una tarjeta de una pantalla o un panel muestra la imagen entera con un punto en cada texto, el suyo encendido, y dice cuál es — 1 de 4; un toque en la foto muestra solo el texto.","Traditional":"Tradicional","Simplified":"Simplificado","Nothing could be read.":"No se pudo leer nada.","Reading the text …":"Leyendo el texto …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Desliza la tarjeta cerrada a izquierda o derecha para elegir otra — no se califica nada, y la que saltas sigue pendiente para la próxima vez.",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Puntúate: Difícil, Medio, Fácil. La tarjeta vuelve antes o después, ese es todo el truco. ¿Nada pendiente? Adelanta las siguientes tarjetas.",
  "All your cards, newest first. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Todas tus tarjetas, las más recientes primero. Búscalas, filtra por marca o etiqueta, toca una para su detalle con Probar, Editar y Eliminar. + Nueva crea una tarjeta a mano, carácter dibujado incluido. Desliza una tarjeta abierta hacia un lado para ver la siguiente de la lista.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Las etiquetas agrupan tarjetas por clase o nivel, y una tarjeta hecha con una foto recibe una según lo que sea — Menú, Tienda, Producto, Aparato y demás; en Más → Aprender, «Etiquetar todas las tarjetas» también se la da a las antiguas. Aprender muestra las etiquetas que elijas. Mantén pulsada una tarjeta para marcar varias y borrarlas juntas — una foto en la pestaña Cámara igual. Toca la estrella de una tarjeta para marcarla — el filtro muestra entonces solo tus tarjetas con estrella, y Aprender las practica todas, toquen hoy o no.",
...
"Updated.":"アップデートしました。",
  ...
  "List":"リスト",
  "Tiles":"タイル",
  "Show {0} that already made cards":"カードになった{0}を表示",
  "Hide them":"隠す",
  "Crop":"切り抜き",
  "Turn the frame":"枠を回す",
  ...
  "{0} cards from this photo, {1} known.":"この写真からカード{0}枚、うち{1}枚は習得済み。","{0} texts on this page, {1} known.":"このページのテキスト{0}件、うち{1}件は習得済み。",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"複数のカードになった写真には、テキストごとに点が付きます。タップすると漢字・ピンイン・意味が出て、その場で評価できます。",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"テキストが複数ある写真 — アプリの画面、操作パネル、メニュー — は、画像全体で1枚のカードになり、テキストごとに点が付きます。カード一覧では1行、学習ではそのテキストを一つずつ出します。",
  "Nothing could be read. Tap Crop to frame the text by hand.":"何も読み取れませんでした。切り抜きをタップして、文字を手で枠に入れてください。",
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"AIに接続できず、読み取りだけではカードにするには不確かすぎました。切り抜きをタップして、写真をもう一度読み取ってください。",
  ...
  ", or the photo for the text alone":"。写真をタップするとこの文字だけが見られます","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"画面や操作パネルからのカードは、テキストごとに点が付いた画像全体を表示し、自分の点が光ります。何番目かも「1 / 4」のように示し、写真をタップするとこの文字だけが見られます。","Traditional":"繁体字","Simplified":"簡体字","Nothing could be read.":"何も読み取れませんでした。","Reading the text …":"文字を読み取り中 …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"答えを開く前のカードを左右にスワイプすると、別のカードを選べます。評価はされないので、飛ばしたカードは次回にまた出てきます。",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"自分で評価します：難しい、普通、簡単。カードは早めか遅めにまた出てきます。それだけの仕組みです。復習がない日は次のカードを前倒しできます。",
  "All your cards, newest first. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"カードは新しい順に並びます。検索し、印やタグで絞り、タップすると詳細（テスト、編集、削除）が開きます。「+ 新規」で手入力のカードを作れます。文字の手書きもできます。開いたカードを横にスワイプすると、リストの次のカードが出てきます。",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"タグでカードを授業やレベルごとにまとめられます。写真から作ったカードには、その中身を表すタグ（メニュー、店、商品、家電など）が付き、その他 → 学習の「すべてのカードにタグを付ける」で古いカードにも付けられます。学習では選んだタグのカードが出ます。カードを長押しすると複数を選んでまとめて削除できます。カメラタブの写真も同じです。 カードの星をタップすると印を付けられます。フィルターでは星付きのカードだけが表示され、学習では期限に関係なく星付きのカードをすべて練習します。",
...
"Updated.":"업데이트했어요.",
  ...
  "List":"목록",
  "Tiles":"타일",
  "Show {0} that already made cards":"카드가 된 {0} 보기",
  "Hide them":"숨기기",
  "Crop":"자르기",
  ...
  "{0} cards from this photo, {1} known.":"이 사진에서 카드 {0}장, 그중 {1}장은 익힘.","{0} texts on this page, {1} known.":"이 페이지의 텍스트 {0}개, 그중 {1}개는 익힘.",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"카드가 여러 장 만들어진 사진에는 텍스트마다 점이 표시돼요. 하나를 탭하면 한자, 병음, 뜻이 뜨고 그 자리에서 바로 평가할 수 있어요.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"텍스트가 여러 개인 사진 — 앱 화면, 조작판, 메뉴판 — 은 사진 전체가 카드 한 장이 되고, 텍스트마다 점이 찍혀요. 카드 목록에는 한 줄로 들어가고, 학습에서는 그 텍스트를 하나씩 봐요.",
  "Nothing could be read. Tap Crop to frame the text by hand.":"아무것도 읽지 못했어요. 자르기를 눌러 글자를 손으로 테두리에 넣어 주세요.",
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"AI에 연결할 수 없었고, 읽기만으로는 카드로 만들기엔 너무 불확실했어요. 자르기를 눌러 사진을 다시 읽어 주세요.",
  ...
  ", or the photo for the text alone":". 사진을 누르면 이 글자만 보여요","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"화면이나 조작판에서 만든 카드는 텍스트마다 점이 찍힌 사진 전체를 보여 주고, 자기 점은 빛나요. 몇 번째인지도 「1 / 4」처럼 알려 주고, 사진을 누르면 이 글자만 보여요.","Traditional":"번체자","Simplified":"간체자","Nothing could be read.":"아무것도 읽지 못했어요.","Reading the text …":"글자를 읽는 중 …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"답을 열기 전 카드를 좌우로 밀면 다른 카드를 고를 수 있어요. 평가는 안 되니까 건너뛴 카드는 다음에 다시 나와요.",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"스스로 평가해요: 어려움, 보통, 쉬움. 카드는 빨리 또는 늦게 다시 나와요. 그게 전부예요. 복습할 게 없으면 다음 카드를 앞당겨요.",
  "All your cards, newest first. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"모든 카드가 최신 순으로 있어요. 검색하고, 표시나 태그로 거르고, 누르면 테스트·편집·삭제가 있는 상세가 열려요. + 새로 만들기로 직접 카드를 만들고, 글자를 손으로 쓸 수도 있어요. 열어 둔 카드를 옆으로 밀면 목록의 다음 카드가 나와요.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"태그로 카드를 수업이나 레벨별로 묶어요. 사진으로 만든 카드에는 그게 뭔지 알려주는 태그(메뉴, 가게, 제품, 가전 등)가 붙고, 더 보기 → 학습의 ‘모든 카드에 태그 달기’로 예전 카드에도 붙일 수 있어요. 학습에서는 고른 태그의 카드가 나와요. 카드를 길게 누르면 여러 장을 골라 한 번에 지울 수 있어요. 카메라 탭의 사진도 같아요. 카드의 별표를 누르면 표시해 둘 수 있어요. 필터에서 별표 있는 카드만 보이고, 학습에서는 기한과 상관없이 별표 카드를 모두 연습해요.",
...
"Updated.":"Обновлено.",
  ...
  "List":"Список",
  "Tiles":"Плитка",
  "Show {0} that already made cards":"Показать {0}, которые уже стали карточками",
  "Hide them":"Скрыть",
  "Crop":"Обрезать",
  ...
  "{0} cards from this photo, {1} known.":"Карточек с этого фото: {0}, освоено: {1}.","{0} texts on this page, {1} known.":"Текстов на этой странице: {0}, освоено: {1}.",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"На фото, из которого вышло несколько карточек, у каждого текста стоит точка — нажми на неё, чтобы увидеть иероглифы, пиньинь и значение, и оцени прямо там.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"Фото с несколькими текстами — экран приложения, панель управления, меню — становится одной карточкой на всё изображение с точкой у каждого текста: одна строка в Карточках, а Учить проходит его тексты по одному.",
  "Nothing could be read. Tap Crop to frame the text by hand.":"Прочитать не вышло. Нажми «Обрезать» и обведи текст сам.",
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"ИИ был недоступен, а одного чтения слишком мало для карточки. Нажми «Обрезать», чтобы прочитать фото ещё раз.",
  ...
  ", or the photo for the text alone":", или на фото — чтобы увидеть только этот текст","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"Карточка с экрана или панели показывает всё изображение с точкой у каждого текста, своя точка светится, и говорит, которая она по счёту — 1 из 4; нажатие на фото показывает только этот текст.","Traditional":"Традиционные","Simplified":"Упрощённые","Nothing could be read.":"Прочитать ничего не вышло.","Reading the text …":"Читаю текст …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Проведи по закрытой карточке влево или вправо, чтобы выбрать другую — оценка не ставится, а пропущенная карточка останется на следующий раз.",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Оцени себя сам: «Трудно», «Средне», «Легко». Карточка вернётся раньше или позже — в этом весь фокус. Ничего не ждёт? Возьми следующие карточки заранее.",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Теги собирают карточки по курсу или уровню, а карточка с фото получает тег по тому, что на нём: «Меню», «Магазин», «Товар», «Техника» и так далее; «Ещё» → «Учёба» → «Теги для всех карточек» проставит их и старым карточкам. «Учить» показывает те теги, которые ты выберешь. Задержи палец на карточке, чтобы отметить несколько и удалить их разом — с фото во вкладке «Камера» точно так же. Нажми на звёздочку у карточки, чтобы отметить её, — фильтр тогда показывает только карточки со звездой, а «Учить» берёт их все, даже те, что ещё не пора.",
...
"Updated.":"Đã cập nhật.",
  ...
  "List":"Danh sách",
  "Tiles":"Ô vuông",
  "Show {0} that already made cards":"Xem {0} đã thành thẻ",
  "Hide them":"Ẩn đi",
  "Crop":"Cắt ảnh",
  ...
  "{0} cards from this photo, {1} known.":"{0} thẻ từ ảnh này, {1} đã thuộc.","{0} texts on this page, {1} known.":"{0} đoạn chữ trên trang này, {1} đã thuộc.",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Ảnh nào tạo ra nhiều thẻ sẽ có một chấm ở mỗi đoạn chữ — chạm vào để xem chữ, pinyin và nghĩa, rồi chấm điểm ngay tại đó.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"Ảnh có nhiều đoạn chữ — màn hình ứng dụng, bảng điều khiển, thực đơn — thành một thẻ cho cả ảnh với một chấm ở mỗi đoạn chữ: một dòng trong Thẻ, và Học sẽ lần lượt đi qua từng đoạn chữ của nó.",
  "Nothing could be read. Tap Crop to frame the text by hand.":"Không đọc được gì. Chạm Cắt ảnh để tự khoanh lấy chữ.",
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"Không kết nối được với AI, và bản đọc một mình chưa đủ chắc để làm thẻ. Chạm Cắt ảnh để đọc lại ảnh nhé.",
  ...
  ", or the photo for the text alone":", hoặc chạm vào ảnh để xem riêng đoạn chữ này","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"Thẻ từ một màn hình hay bảng điều khiển hiện cả ảnh với một chấm ở mỗi đoạn chữ, chấm của nó sáng lên, và cho biết nó là thẻ thứ mấy — 1/4; chạm vào ảnh để xem riêng đoạn chữ này.","Traditional":"Phồn thể","Simplified":"Giản thể","Nothing could be read.":"Không đọc được gì.","Reading the text …":"Đang đọc chữ …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Vuốt thẻ chưa mở sang trái hoặc phải để chọn thẻ khác — không chấm điểm gì cả, thẻ bạn bỏ qua vẫn còn đó cho lần sau.",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Tự chấm điểm: Khó, Vừa, Dễ. Thẻ sẽ quay lại sớm hay muộn tùy vào đó, cả bí quyết nằm ở chỗ này. Không có thẻ nào đến hạn? Kéo các thẻ tiếp theo lên học trước.",
  "All your cards, newest first. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Tất cả thẻ của bạn, mới nhất lên đầu. Tìm kiếm, lọc theo đánh dấu hay nhãn, chạm một thẻ để xem chi tiết với Kiểm tra, Sửa và Xóa. + Mới cho bạn tự làm một thẻ, vẽ chữ luôn cũng được. Đẩy thẻ đang mở sang ngang để xem thẻ tiếp theo trong danh sách.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Nhãn giúp gom thẻ theo lớp học hay theo trình độ, và thẻ làm từ ảnh được gắn sẵn một nhãn cho biết nó là gì — Thực đơn, Cửa hàng, Sản phẩm, Thiết bị và tương tự; Thêm → Học tập → Gắn nhãn mọi thẻ sẽ gắn cho cả những thẻ cũ. Tab Học chỉ đưa ra thẻ thuộc các nhãn bạn chọn. Nhấn giữ một thẻ để đánh dấu nhiều thẻ rồi xóa cùng lúc — ảnh ở tab Máy ảnh cũng vậy. Chạm vào ngôi sao trên một thẻ để đánh dấu thẻ đó — bộ lọc khi ấy chỉ hiện thẻ có sao, và Học sẽ học tất cả, đến hạn hay chưa.",
...
"Updated.":"อัปเดตแล้ว",
  ...
  "List":"รายการ",
  "Tiles":"ตาราง",
  "Show {0} that already made cards":"ดู{0}ที่กลายเป็นการ์ดแล้ว",
  "Hide them":"ซ่อน",
  "Crop":"ครอบตัด",
  ...
  "{0} cards from this photo, {1} known.":"การ์ด {0} ใบ จากรูปนี้ จำได้แล้ว {1} ใบ","{0} texts on this page, {1} known.":"ข้อความ {0} จุดในหน้านี้ จำได้แล้ว {1}",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"รูปที่ทำการ์ดได้หลายใบจะมีจุดอยู่ที่ข้อความแต่ละจุด แตะดูตัวอักษร พินอิน และความหมาย แล้วให้คะแนนตรงนั้นได้เลย",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"รูปที่มีข้อความหลายจุด — หน้าจอแอป แผงควบคุม เมนู — จะกลายเป็นการ์ดใบเดียวสำหรับทั้งรูป มีจุดที่ข้อความแต่ละจุด เป็นหนึ่งแถวในการ์ด และการเรียนจะพาไปทีละข้อความ",
  "Nothing could be read. Tap Crop to frame the text by hand.":"อ่านอะไรไม่ได้เลย แตะ ครอบตัด เพื่อวาดกรอบเอง",
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"ติดต่อ AI ไม่ได้ และการอ่านอย่างเดียวยังไม่แน่พอจะทำการ์ด แตะ ครอบตัด เพื่ออ่านรูปอีกครั้ง",
  ...
  ", or the photo for the text alone":" หรือแตะรูปเพื่อดูเฉพาะข้อความนี้","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"การ์ดจากหน้าจอหรือแผงควบคุมจะแสดงรูปทั้งรูป มีจุดที่ข้อความแต่ละจุด จุดของตัวเองจะสว่าง และบอกว่าเป็นใบที่เท่าไร เช่น 1 จาก 4 แตะรูปเพื่อดูเฉพาะข้อความนี้","Traditional":"ตัวเต็ม","Simplified":"ตัวย่อ","Nothing could be read.":"อ่านอะไรไม่ได้เลย","Reading the text …":"กำลังอ่านตัวอักษร …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"ปัดการ์ดที่ยังไม่เปิดคำตอบไปทางซ้ายหรือขวาเพื่อเลือกใบอื่น ไม่มีการให้คะแนน การ์ดที่ข้ามไปจะยังค้างไว้ให้ทบทวนคราวหน้า",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"ให้คะแนนตัวเอง: ยาก ปานกลาง ง่าย การ์ดจะกลับมาเร็วหรือช้าตามนั้น เคล็ดลับมีแค่นี้ วันไหนไม่มีการ์ดถึงกำหนด ก็ดึงการ์ดถัดไปมาก่อนได้",
  "All your cards, newest first. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"การ์ดทั้งหมดของคุณ เรียงใหม่สุดก่อน ค้นหาได้ กรองตามธงหรือแท็กได้ แตะการ์ดเพื่อดูรายละเอียดพร้อมปุ่มทดสอบ แก้ไข และลบ ปุ่ม + ใหม่ ใช้สร้างการ์ดเอง จะเขียนตัวอักษรเองก็ได้ ปัดการ์ดที่เปิดอยู่ไปด้านข้างเพื่อดูการ์ดถัดไปในรายการ",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"แท็กใช้จัดกลุ่มการ์ดตามคลาสหรือระดับ และการ์ดที่มาจากรูปจะได้แท็กตามสิ่งที่อยู่ในรูป — เมนู ร้านค้า สินค้า เครื่องใช้ไฟฟ้า และอื่นๆ ส่วนการ์ดเก่าใช้ อื่นๆ → การเรียน → ติดแท็กการ์ดทั้งหมด ได้ แท็บเรียนจะแสดงเฉพาะการ์ดในแท็กที่คุณเลือก กดค้างที่การ์ดเพื่อเลือกหลายใบแล้วลบพร้อมกัน รูปในแท็บกล้องก็ทำแบบเดียวกัน แตะดาวบนการ์ดเพื่อทำเครื่องหมายไว้ ตัวกรองจะแสดงเฉพาะการ์ดที่ติดดาว และแท็บเรียนจะเรียนการ์ดติดดาวทั้งหมด ไม่ว่าจะถึงกำหนดหรือยัง",
...
"Updated.":"Diperbarui.",
  ...
  "List":"Daftar",
  "Tiles":"Petak",
  "Show {0} that already made cards":"Lihat {0} yang sudah jadi kartu",
  ...
  "{0} cards from this photo, {1} known.":"{0} kartu dari foto ini, {1} sudah dikuasai.","{0} texts on this page, {1} known.":"{0} teks di halaman ini, {1} sudah dikuasai.",
  "A photo that made several cards shows a dot on each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Foto yang menghasilkan beberapa kartu menampilkan titik di setiap teks — ketuk satu untuk melihat karakter, pinyin, dan artinya, lalu nilai langsung di situ.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a dot on every text: one row under Cards, and Learn goes through its texts one by one.":"Foto dengan beberapa teks — layar aplikasi, panel kontrol, daftar menu — menjadi satu kartu untuk seluruh gambar dengan titik di setiap teks: satu baris di Kartu, dan Belajar melewati teksnya satu per satu.",
  ...
  "The AI could not be reached, and the reading alone was too unsure for a card. Tap Crop to read the photo again.":"AI tidak bisa dihubungi, dan hasil bacanya saja terlalu meragukan untuk jadi kartu. Ketuk Pangkas untuk membaca fotonya lagi.",
  ...
  ", or the photo for the text alone":", atau foto untuk melihat teksnya saja","A card from a screen or a panel shows the whole picture with a dot on every text and its own dot lit, and says which one it is, 1 of 4; a tap on the photo shows the text alone.":"Kartu dari layar atau panel menampilkan seluruh gambar dengan titik di setiap teks, titiknya sendiri menyala, dan menyebut yang ke berapa — 1 dari 4; ketuk foto untuk melihat teksnya saja.","Traditional":"Tradisional","Simplified":"Sederhana","Nothing could be read.":"Tidak ada yang bisa dibaca.","Reading the text …":"Membaca teks …",
...
"Swipe the closed card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Geser kartu yang belum dibuka ke kiri atau kanan untuk memilih kartu lain — tidak ada penilaian, dan kartu yang kamu lewati tetap menunggu untuk lain kali.",
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Nilai dirimu sendiri: Sulit, Sedang, Mudah. Kartunya balik lagi lebih cepat atau lebih lama, itu saja rahasianya. Tidak ada yang perlu diulang? Majukan kartu berikutnya.",
  "All your cards, newest first. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Semua kartumu, yang terbaru di atas. Cari, filter lewat tanda atau tag, ketuk satu untuk melihat detailnya dengan Tes, Edit dan Hapus. Tombol + Baru membuat kartu sendiri, lengkap dengan karakter yang kamu gambar. Geser kartu yang terbuka ke samping untuk kartu berikutnya di daftar.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Tag mengelompokkan kartu untuk sebuah kelas atau tingkat, dan kartu dari foto langsung dapat satu sesuai isinya — Menu, Toko, Produk, Elektronik dan seterusnya; Lainnya → Belajar → Beri tag semua kartu memberi tag juga ke kartu lama. Tab Belajar menampilkan tag yang kamu pilih. Tekan lama sebuah kartu untuk menandai beberapa dan menghapusnya sekaligus — foto di tab Kamera juga begitu. Ketuk bintang pada sebuah kartu untuk menandainya — filter lalu hanya menampilkan kartu berbintang kamu, dan Belajar melatih semuanya, jatuh tempo atau belum.",
