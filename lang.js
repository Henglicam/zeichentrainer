...
de:{
  ...
  "Open":"Öffnen",
  "Camera → Take photo, or From album. The app looks for the text and draws a frame around it while it reads. Drag a corner or the inside to fit it, the round handle turns it. Let go, and the reading starts again. Tap outside the frame to see the framed part large.":"Kamera → Foto aufnehmen oder Aus dem Album. Die App sucht den Text und legt beim Lesen einen Rahmen darum. Zieh an einer Ecke oder innen, bis er passt, der runde Griff dreht ihn. Loslassen, und das Lesen startet neu. Tipp außerhalb des Rahmens, um den Ausschnitt groß zu sehen.",
...
fr:{
  ...
  "Open":"Ouvrir",
  "Camera → Take photo, or From album. The app looks for the text and draws a frame around it while it reads. Drag a corner or the inside to fit it, the round handle turns it. Let go, and the reading starts again. Tap outside the frame to see the framed part large.":"Photo → Prendre une photo, ou Depuis l'album. L'appli cherche le texte et pose un cadre autour pendant la lecture. Tire un coin ou l'intérieur pour l'ajuster, la poignée ronde le tourne. Lâche, et la lecture repart. Touche hors du cadre pour voir la partie cadrée en grand.",
...
es:{
  ...
  "Open":"Abrir",
  "Camera → Take photo, or From album. The app looks for the text and draws a frame around it while it reads. Drag a corner or the inside to fit it, the round handle turns it. Let go, and the reading starts again. Tap outside the frame to see the framed part large.":"Cámara → Hacer foto, o Del álbum. La app busca el texto y pone un marco alrededor mientras lee. Arrastra una esquina o el interior para ajustarlo, el mando redondo lo gira. Suelta, y la lectura empieza de nuevo. Toca fuera del marco para ver la parte enmarcada en grande.",
...
ja:{
  ...
  "Open":"開く",
  "Camera → Take photo, or From album. The app looks for the text and draws a frame around it while it reads. Drag a corner or the inside to fit it, the round handle turns it. Let go, and the reading starts again. Tap outside the frame to see the framed part large.":"カメラ → 写真を撮る、またはアルバムから。アプリがテキストを探し、読み取りながらその周りに枠を引きます。角や内側をドラッグして合わせ、丸いハンドルで回します。指を離すと読み取りがやり直されます。枠の外をタップすると枠内を大きく見られます。",
...
ko:{
  ...
  "Open":"열기",
  "Camera → Take photo, or From album. The app looks for the text and draws a frame around it while it reads. Drag a corner or the inside to fit it, the round handle turns it. Let go, and the reading starts again. Tap outside the frame to see the framed part large.":"카메라 → 사진 찍기, 또는 앨범에서. 앱이 텍스트를 찾아 읽는 동안 그 둘레에 테두리를 그려요. 모서리나 안쪽을 끌어 맞추고, 둥근 손잡이로 돌려요. 손을 떼면 읽기가 다시 시작돼요. 테두리 바깥을 누르면 테두리 안을 크게 볼 수 있어요.",
