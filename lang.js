...
ru:{
  ...
  "time":"{0} раз","times":"{0} раза","times#many":"{0} раз","AI check":"{0} проверка ИИ","AI checks":"{0} проверки ИИ",
  ...
  "Test this card":"Проверить эту карточку","Edit":"Изменить","Delete card":"Удалить карточку","Delete “{0}”?":"Удалить «{0}»?","Delete this card?":"Удалить эту карточку?",
  "The card and its learning progress will be removed.":"Карточка и её прогресс пропадут.","Delete":"Удалить","Cancel":"Отмена",
  ...
  /* More, the Add and Edit forms and the notices (v255) */
  "Copied to the clipboard.":"Скопировано в буфер обмена.","Sharing is not available here.":"Здесь нельзя поделиться.","Works offline. Cards and photos stay on this phone; anonymous usage counts go to the app's owner.":"Работает офлайн. Карточки и фото остаются на этом телефоне; владельцу приложения уходят только обезличенные счётчики.",
  "Only when the reading is weak, the framed area of a photo goes to {0}.":"Только когда чтение слабое, обведённая часть фото уходит к {0}.",
  ...
  "Progress":"Прогресс","App opened {0}, {1} reviewed, {2}, {3} checked by the AI.":"Приложение открыто {0}, повторов {1}, {2}, {3} проверено ИИ.","Work done by {0}.":"Работу сделали: {0}.",
...
vi:{
  ...
  "time":"{0} lần","times":"{0} lần","AI check":"{0} lượt kiểm tra AI","AI checks":"{0} lượt kiểm tra AI",
  ...
  "Test this card":"Kiểm tra thẻ này","Edit":"Sửa","Delete card":"Xóa thẻ","Delete “{0}”?":"Xóa “{0}”?","Delete this card?":"Xóa thẻ này?",
  "The card and its learning progress will be removed.":"Thẻ và tiến độ học của nó sẽ bị xóa.","Delete":"Xóa","Cancel":"Hủy",
  ...
  /* More, the Add and Edit forms and the notices (v255) */
  "Copied to the clipboard.":"Đã sao chép.","Sharing is not available here.":"Ở đây không chia sẻ được.","Works offline. Cards and photos stay on this phone; anonymous usage counts go to the app's owner.":"Chạy được cả khi không có mạng. Thẻ và ảnh chỉ nằm trên máy này; chỉ vài số liệu sử dụng ẩn danh là gửi cho chủ app.",
  "Only when the reading is weak, the framed area of a photo goes to {0}.":"Chỉ khi đọc kém thì vùng ảnh đã khoanh mới được gửi tới {0}.",
  ...
  "Progress":"Tiến độ","App opened {0}, {1} reviewed, {2}, {3} checked by the AI.":"Mở app {0}, ôn {1}, {2}, AI kiểm tra {3}.","Work done by {0}.":"Việc do {0} làm.",
...
th:{
  ...
  "time":"{0} ครั้ง","times":"{0} ครั้ง","AI check":"AI ตรวจ {0} ครั้ง","AI checks":"AI ตรวจ {0} ครั้ง",
  ...
  "Test this card":"ทดสอบการ์ดนี้","Edit":"แก้ไข","Delete card":"ลบการ์ด","Delete “{0}”?":"ลบ “{0}” ไหม","Delete this card?":"ลบการ์ดนี้ไหม",
  "The card and its learning progress will be removed.":"การ์ดและความคืบหน้าการเรียนจะถูกลบไป","Delete":"ลบ","Cancel":"ยกเลิก",
  ...
  /* More, the Add and Edit forms and the notices (v255) */
  "Copied to the clipboard.":"คัดลอกแล้ว","Sharing is not available here.":"ที่นี่แชร์ไม่ได้","Works offline. Cards and photos stay on this phone; anonymous usage counts go to the app's owner.":"ใช้ได้แบบออฟไลน์ การ์ดและรูปอยู่ในเครื่องนี้ ส่วนสถิติการใช้งานแบบไม่ระบุตัวตนจะส่งให้เจ้าของแอป",
  "Only when the reading is weak, the framed area of a photo goes to {0}.":"เฉพาะตอนที่อ่านได้ไม่ดี ส่วนที่อยู่ในกรอบของรูปจะถูกส่งไปที่ {0}",
  ...
  "Progress":"ความคืบหน้า","App opened {0}, {1} reviewed, {2}, {3} checked by the AI.":"เปิดแอป {0} · ทบทวน {1} · {2} · AI ตรวจ {3}","Work done by {0}.":"งานที่ทำโดย {0}",
...
id:{
  ...
  "time":"{0} kali","times":"{0} kali","AI check":"{0} pemeriksaan AI","AI checks":"{0} pemeriksaan AI",
  ...
  "Test this card":"Tes kartu ini","Edit":"Edit","Delete card":"Hapus kartu","Delete “{0}”?":"Hapus “{0}”?","Delete this card?":"Hapus kartu ini?",
  "The card and its learning progress will be removed.":"Kartu dan kemajuan belajarnya akan dihapus.","Delete":"Hapus","Cancel":"Batal",
  ...
  /* More, the Add and Edit forms and the notices (v255) */
  "Copied to the clipboard.":"Disalin ke papan klip.","Sharing is not available here.":"Berbagi tidak tersedia di sini.","Works offline. Cards and photos stay on this phone; anonymous usage counts go to the app's owner.":"Jalan tanpa internet. Kartu dan foto tetap di ponsel ini; hitungan pemakaian yang anonim dikirim ke pemilik aplikasi.",
  "Only when the reading is weak, the framed area of a photo goes to {0}.":"Hanya kalau hasil bacanya lemah, bagian foto di dalam bingkai dikirim ke {0}.",
  ...
  "Progress":"Kemajuan","App opened {0}, {1} reviewed, {2}, {3} checked by the AI.":"Aplikasi dibuka {0}, {1} diulang, {2}, {3}.","Work done by {0}.":"Dikerjakan oleh {0}.",
