...
de:{
  ...
  "A photo of separate labels — the buttons of a rice cooker, the items of a menu board — becomes one card per label, each with its own cut of the photo.":"Ein Foto mit einzelnen Beschriftungen — die Tasten am Reiskocher, die Gerichte auf einer Menütafel — wird zu einer Karte pro Beschriftung, jede mit ihrem eigenen Bildausschnitt.",
...
fr:{
  ...
  "A photo of separate labels — the buttons of a rice cooker, the items of a menu board — becomes one card per label, each with its own cut of the photo.":"Une photo d'étiquettes séparées — les touches d'un cuiseur à riz, les plats d'un menu — donne une carte par étiquette, chacune avec son propre bout de photo.",
...
es:{
  ...
  "A photo of separate labels — the buttons of a rice cooker, the items of a menu board — becomes one card per label, each with its own cut of the photo.":"Una foto con etiquetas sueltas — los botones de una arrocera, los platos de una carta — se convierte en una tarjeta por etiqueta, cada una con su propio recorte.",
...
ja:{
  ...
  "A photo of separate labels — the buttons of a rice cooker, the items of a menu board — becomes one card per label, each with its own cut of the photo.":"別々のラベルが写った写真 — 炊飯器のボタン、メニュー表の品目 — は、ラベルごとに1枚のカードになります。それぞれ自分の切り抜き付きです。",
...
ko:{
  ...
  "A photo of separate labels — the buttons of a rice cooker, the items of a menu board — becomes one card per label, each with its own cut of the photo.":"따로 떨어진 라벨이 담긴 사진 — 밥솥 버튼, 메뉴판 항목 — 은 라벨마다 카드 한 장이 돼요. 각자 자기 사진 조각을 가져요.",
