...
de:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"Erklären unter der Bedeutung bittet die KI um ein paar Sätze zur Karte — was der Text sagt und wo er dir begegnet.",
  "Show me":"Zeig mir",
  "Skip":"Überspringen",
  "Again":"Nochmal",
  ...
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"Keine Vorlage und keine Strichreihenfolge: Schreib das ganze Zeichen, tipp auf Fertig, und die App prüft es. Für Zeichen, die du schon kannst.",
  "Write freehand":"Frei schreiben",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"Handschrift unter Mehr → Lernen nimmt die Vorlage weg: Schreib das ganze Zeichen in deiner eigenen Strichreihenfolge und tipp auf Fertig.",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"Lernen zeigt die fälligen Karten, dann bis zu acht neue. Das Foto ist der Hinweis, die Zeichen darunter sind die Knöpfe, und das Schreibfeld ist die Antwort: Zieh den leuchtenden Strich nach, und das Feld geht von selbst weiter – Zeichen für Zeichen, dann zur nächsten Karte. Vier Zeichen pro Zeile und zwei Zeilen lassen sich am besten fotografieren.",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Über dem Schreibfeld zeigt das Wort, das du gerade schreibst, sein Pinyin und seine Bedeutung; die Zeichen, das Pinyin und die Bedeutung der ganzen Karte liegen eingeklappt am Fuß der Karte — klapp sie auf, wenn du sie brauchst. Hängst du an einem Strich? Zeig mir malt ihn vor, Überspringen setzt ihn für dich. Eine geschriebene Karte kommt ein paar Karten später noch einmal, und je besser du sie kannst, desto weniger Vorlage bleibt. Nichts fällig? Hol die nächsten Karten vor.",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Wisch die Karte nach links oder rechts, um eine andere zu wählen – nichts wird bewertet, und eine übersprungene Karte bleibt fürs nächste Mal fällig.",
"⚑ Flag":"⚑ Markieren",
...
"Updated.":"Aktualisiert.",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"Ist die Lesung eindeutig, erscheint die Karte sofort, und die KI-Prüfung verfeinert sie kurz darauf.",
  ...
  "From {0}":"Aus {0}",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Tippe auf einen Text in einer Multicard, um ihn nachzuschlagen, und mach mit „Karte erstellen“ eine Karte daraus. Lernen übt die Karten, nie die Multicard selbst.",
  "Language":"Sprache",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Eine Karte, die aus einer Multicard erstellt wurde, zeigt das ganze Bild der Multicard mit einem Rahmen nur um ihren eigenen Text und nennt die Multicard unter der Bedeutung; tipp auf den Namen, um die Multicard nachzuschlagen, und ← Zurück bringt dich zur Karte zurück.","Traditional":"Langzeichen","Simplified":"Kurzzeichen","Nothing could be read.":"Es konnte nichts gelesen werden.","Reading the text …":"Text wird gelesen …",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Alle deine Karten, neueste zuerst. Sobald ein Foto eine Multicard ergeben hat, teilen zwei Reiter sie auf — Karten und Multicards. Durchsuche sie, filtere nach Markierung oder Tag, tipp eine an für die Detailansicht mit Testen, Bearbeiten und Löschen. + Neu legt eine Karte von Hand an, gezeichnetes Zeichen inklusive. Schieb eine offene Karte zur Seite, dann kommt die nächste aus der Liste.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Tags gruppieren Karten für einen Kurs oder ein Niveau, und eine Karte aus einem Foto bekommt eins dafür, was sie ist — Speisekarte, Laden, Produkt, Gerät und so weiter; unter Mehr → Lernen gibt „Alle Karten taggen“ auch den älteren Karten eins. Lernen zeigt die Tags, die du wählst. Halte eine Karte gedrückt, um mehrere zu markieren und zusammen zu löschen; alte Fotos räumst du unter Mehr → Deine Daten → Fotos weg. Tippe auf den Stern einer Karte, um sie dir zu merken — der Filter zeigt dann nur deine Karten mit Stern, und beim Lernen kommen alle dran, fällig oder nicht.",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"Karten und Fotos bleiben auf diesem Telefon und sonst nirgends – exportiere sie ab und zu unter Mehr → Deine Daten. Die KI-Prüfung sendet den chinesischen Text, Pinyin und Bedeutung einer Karte und, wenn der Text schwer zu lesen ist, ein Bild davon – manchmal das ganze Foto.",
...
fr:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"Expliquer, sous le sens, demande à l’IA quelques phrases sur la carte — ce que dit le texte et où tu le rencontres.",
  "Show me":"Montre-moi",
  "Skip":"Passer",
  "Again":"Encore",
  "Written today":"Écrit aujourd'hui",
  "Points":"Points",
  "Handwriting":"Écriture à la main",
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"Pas de modèle, pas d'ordre des traits : écris le caractère en entier, touche Terminé, et l'app vérifie. Pour les caractères que tu connais déjà.",
  "Write freehand":"Écrire librement",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"Écriture à la main, dans Plus → Apprendre, enlève le modèle : écris le caractère entier dans ton propre ordre de traits et touche Terminé.",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"Apprendre montre les cartes à revoir, puis jusqu'à huit nouvelles. La photo est l'indice, les caractères en dessous sont les boutons, et le carré d'écriture est la réponse : trace le trait allumé, et le carré passe au suivant tout seul — caractère par caractère, puis à la carte suivante. Quatre caractères par ligne et deux lignes, c'est ce qui se photographie le mieux.",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Au-dessus du carré, le mot que tu écris affiche son pinyin et son sens ; les caractères, le pinyin et le sens de toute la carte sont repliés au bas de la carte — ouvre-les quand tu en as besoin. Bloqué sur un trait ? Montre-moi le dessine, Passer le pose pour toi. Une carte écrite revient quelques cartes plus loin, avec de moins en moins de modèle à mesure que tu la connais. Rien à revoir ? Avance les prochaines cartes.",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Balaie la carte vers la gauche ou la droite pour en choisir une autre — rien n'est noté, et une carte sautée reste due pour la prochaine fois.",
"⚑ Flag":"⚑ Signaler",
...
"Updated.":"Mis à jour.",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"Quand la lecture est nette, la carte apparaît tout de suite, et la vérification de l'IA l'affine un instant plus tard.",
  ...
  "From {0}":"De {0}",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Touche un texte d’une multicarte pour le consulter, et appuie sur « Créer une carte » pour en faire une carte. Apprendre travaille les cartes, jamais la multicarte elle-même.",
  "Language":"Langue",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Une carte créée à partir d'une multicarte montre l'image entière de la multicarte avec un cadre autour de son seul texte, et nomme la multicarte sous le sens ; touche ce nom pour consulter la multicarte, et ← Retour te ramène à la carte.","Traditional":"Traditionnel","Simplified":"Simplifié","Nothing could be read.":"Rien n'a pu être lu.","Reading the text …":"Lecture du texte …",
  ...
  "Show":"Afficher","Online AI review":"Vérification par l'IA en ligne","AI review":"Vérification par l'IA","What is sent: a card's Chinese text, pinyin, meaning, your note and the reader's other guesses — for every new card, for every card when you tap Check-up, Translate all or Tag all, and for one card when you tap Explain under its meaning. When the reading is hard, a picture of the text goes to a provider that takes pictures — sometimes the whole photo. Without a key of its own this phone sends through the app owner's relay, which forwards to the provider and keeps only a count.":"Ce qui est envoyé : le texte chinois d'une carte, le pinyin, le sens, ta note et les autres lectures de l'appli — pour chaque nouvelle carte et pour chaque carte quand tu touches « Bilan », « Traduire toutes les cartes » ou « Taguer toutes les cartes », et pour une carte quand tu touches « Expliquer » sous son sens. Quand la lecture est difficile, une image du texte est envoyée à un fournisseur qui accepte les images — parfois la photo entière. Sans clé propre, ce téléphone envoie via le relais du propriétaire de l'appli, qui transmet au fournisseur et ne garde qu'un compteur.",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Toutes tes cartes, les plus récentes d'abord. Dès qu'une photo a donné une multicarte, deux onglets les séparent — Cartes et Multicartes. Cherche, filtre par signalement ou tag, touche-en une pour son détail avec Tester, Modifier et Supprimer. + Nouvelle crée une carte à la main, caractère dessiné compris. Pousse une carte ouverte sur le côté pour passer à la suivante de la liste.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Les tags regroupent les cartes pour un cours ou un niveau, et une carte issue d'une photo en reçoit un pour ce qu'elle est — Menu, Boutique, Produit, Appareil, etc. ; dans Plus → Apprendre, « Taguer toutes les cartes » en donne un aussi aux anciennes. Apprendre montre les tags que tu choisis. Appuie longuement sur une carte pour en marquer plusieurs et les supprimer ensemble ; les vieilles photos se nettoient dans Plus → Tes données → Photos. Touche l'étoile d'une carte pour la garder à l'œil — le filtre n'affiche alors que tes cartes avec étoile, et Apprendre les prend toutes, dues ou non.",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"Les cartes et les photos restent sur ce téléphone et nulle part ailleurs — exporte-les de temps en temps sous Plus → Tes données. La vérification par l'IA envoie le texte chinois, le pinyin et le sens d'une carte et, quand la lecture est difficile, une image du texte — parfois la photo entière.",
...
es:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"Explicar, bajo el significado, pide a la IA unas frases sobre la tarjeta: qué dice el texto y dónde te lo encuentras.",
  "Show me":"Muéstrame",
  "Skip":"Saltar",
  "Again":"Otra vez",
  ...
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"Sin plantilla y sin orden de trazos: escribe el carácter entero, toca Listo y la app lo comprueba. Para los caracteres que ya conoces.",
  "Write freehand":"Escribir a mano libre",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"Escritura a mano, en Más → Aprender, quita la plantilla: escribe el carácter entero en tu propio orden de trazos y toca Listo.",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"Aprender muestra las tarjetas pendientes y luego hasta ocho nuevas. La foto es la pista, los caracteres debajo son los botones y el cuadro de escritura es la respuesta: traza el trazo iluminado y el cuadro sigue solo, carácter a carácter y luego a la siguiente tarjeta. Cuatro caracteres por línea y dos líneas es lo que mejor se fotografía.",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Encima del cuadro, la palabra que estás escribiendo muestra su pinyin y su significado; los caracteres, el pinyin y el significado de toda la tarjeta están plegados al pie de la tarjeta — ábrelos cuando los necesites. ¿Atascado en un trazo? Muéstrame lo dibuja, Saltar lo pone por ti. Una tarjeta escrita vuelve unas tarjetas después, con menos plantilla cuanto mejor la sabes. ¿Nada pendiente? Adelanta las siguientes tarjetas.",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Desliza la tarjeta a la izquierda o a la derecha para elegir otra — no se califica nada, y una tarjeta que saltas sigue pendiente para la próxima vez.",
"⚑ Flag":"⚑ Marcar",
...
"Updated.":"Actualizado.",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"Si la lectura es clara, la tarjeta aparece al instante, y la comprobación de la IA la afina un momento después.",
  ...
  "From {0}":"De {0}",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Toca un texto de una multitarjeta para consultarlo y pulsa «Crear tarjeta» para convertirlo en tarjeta. Aprender practica las tarjetas, nunca la multitarjeta.",
  "Language":"Idioma",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Una tarjeta creada a partir de una multitarjeta muestra la imagen entera de la multitarjeta con un marco solo alrededor de su propio texto, y nombra la multitarjeta bajo el significado; toca ese nombre para consultar la multitarjeta, y ← Atrás te devuelve a la tarjeta.","Traditional":"Tradicional","Simplified":"Simplificado","Nothing could be read.":"No se pudo leer nada.","Reading the text …":"Leyendo el texto …",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Todas tus tarjetas, las más recientes primero. En cuanto una foto da una multitarjeta, dos pestañas las separan — Tarjetas y Multitarjetas. Búscalas, filtra por marca o etiqueta, toca una para su detalle con Probar, Editar y Eliminar. + Nueva crea una tarjeta a mano, carácter dibujado incluido. Desliza una tarjeta abierta hacia un lado para ver la siguiente de la lista.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Las etiquetas agrupan tarjetas por clase o nivel, y una tarjeta hecha con una foto recibe una según lo que sea — Menú, Tienda, Producto, Aparato y demás; en Más → Aprender, «Etiquetar todas las tarjetas» también se la da a las antiguas. Aprender muestra las etiquetas que elijas. Mantén pulsada una tarjeta para marcar varias y borrarlas juntas; las fotos antiguas se limpian en Más → Tus datos → Fotos. Toca la estrella de una tarjeta para marcarla — el filtro muestra entonces solo tus tarjetas con estrella, y Aprender las practica todas, toquen hoy o no.",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"Las tarjetas y las fotos se quedan en este teléfono y en ningún otro sitio — expórtalas de vez en cuando en Más → Tus datos. La revisión con IA envía el texto chino, el pinyin y el significado de una tarjeta y, cuando la lectura es difícil, una imagen del texto — a veces la foto entera.",
...
ja:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"意味の下の「解説」をタップすると、AIがこのカードについて数文で説明します — テキストの意味と、どこで見かけるかを。",
  "Show me":"見せて",
  "Skip":"スキップ",
  "Again":"もう一度",
  ...
  "Points":"ポイント",
  "Handwriting":"手書き",
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"お手本も筆順もなし。文字全体を書いて「完了」をタップすると、アプリが確かめます。もう覚えた文字におすすめです。",
  "Write freehand":"自由に書く",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"「その他」→「学習」の手書きをオンにするとお手本が消えます。自分の筆順で文字全体を書いて「完了」をタップしましょう。",
  "Your cards":"カード",
  "The app":"アプリ",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"「学ぶ」には復習のカード、続いて新しいカードが最大8枚出てきます。写真がヒント、その下の文字がボタン、書き取り枠が答えです。光っている画をなぞると自動で次へ進みます。一文字ずつ、そして次のカードへ。一行4文字、2行までが一番きれいに撮れます。",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"書き込み欄の上には、いま書いている単語のピンインと意味が出ます。カード全体の漢字・ピンイン・意味はカードの下端にたたまれているので、必要なときに開いてください。画に詰まったら「見せて」でお手本が動き、「スキップ」で代わりに書いてくれます。書いたカードは数枚あとにもう一度出て、覚えるほどお手本が薄くなります。復習がない？次のカードを前倒しできます。",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"カードを左右にスワイプすると別のカードを選べます。採点はされず、飛ばしたカードは次回もそのまま出てきます。",
"⚑ Flag":"⚑ 印をつける",
"card:⚑ Flagged":"⚑ 印あり",
...
"Updated.":"アップデートしました。",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"読み取りがはっきりしていれば、カードはすぐに表示され、少し後にAIのチェックで整えられます。",
  ...
  "From {0}":"{0} から",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"マルチカードの文字をタップすると意味を調べられます。「カードを作る」を押すと、その文字からカードができます。学習で出てくるのはそのカードで、マルチカード自体は出てきません。",
  "Language":"言語",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"マルチカードから作ったカードは、マルチカードの画像全体を自分のテキストだけ枠で囲んで表示し、意味の下にそのマルチカードの名前を示します。名前をタップするとマルチカードを調べられて、← 戻る でカードに戻れます。","Traditional":"繁体字","Simplified":"簡体字","Nothing could be read.":"何も読み取れませんでした。","Reading the text …":"文字を読み取り中 …",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"カードは新しい順に並びます。写真からマルチカードができると、カードとマルチカードの2つのタブに分かれます。検索し、印やタグで絞り、タップすると詳細（テスト、編集、削除）が開きます。「+ 新規」で手入力のカードを作れます。文字の手書きもできます。開いたカードを横にスワイプすると、リストの次のカードが出てきます。",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"タグでカードを授業やレベルごとにまとめられます。写真から作ったカードには、その中身を表すタグ（メニュー、店、商品、家電など）が付き、その他 → 学習の「すべてのカードにタグを付ける」で古いカードにも付けられます。学習では選んだタグのカードが出ます。カードを長押しすると複数を選んでまとめて削除できます。古い写真は その他 → データ → 写真 で片づけられます。 カードの星をタップすると印を付けられます。フィルターでは星付きのカードだけが表示され、学習では期限に関係なく星付きのカードをすべて練習します。",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"カードと写真はこの端末にだけあります。ときどき「その他 → データ」からエクスポートしてください。AI確認ではカードの中国語、ピンイン、意味を送り、読み取りが難しいときは文字の画像 — ときには写真全体 — を送ります。",
...
ko:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"뜻 아래 ‘설명’을 누르면 AI가 이 카드에 대해 몇 문장으로 알려줘요 — 글의 뜻과 어디서 볼 수 있는지.",
  "Show me":"보여줘",
  "Skip":"건너뛰기",
  "Again":"다시",
  ...
  "Points":"포인트",
  "Handwriting":"손글씨",
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"본보기도 획순도 없어요. 글자 전체를 쓰고 완료를 누르면 앱이 확인해요. 이미 아는 글자에 좋아요.",
  "Write freehand":"자유롭게 쓰기",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"더 보기 → 학습의 손글씨를 켜면 본보기가 사라져요. 네 획순으로 글자 전체를 쓰고 완료를 눌러요.",
  "Your cards":"내 카드",
  "The app":"앱",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"학습에는 복습할 카드가 먼저, 그다음 새 카드가 최대 8장 나와요. 사진이 힌트, 그 아래 글자들이 버튼, 쓰기판이 답이에요. 빛나는 획을 따라 그리면 저절로 넘어가요. 한 글자씩, 그다음 다음 카드로. 한 줄에 네 글자, 두 줄까지가 사진으로 제일 잘 나와요.",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"쓰기판 위에는 지금 쓰는 단어의 병음과 뜻이 보여요. 카드 전체의 한자, 병음, 뜻은 카드 맨 아래에 접혀 있으니 필요할 때 열어 보세요. 획에서 막히면 보여줘가 그려 주고, 건너뛰기가 대신 채워 줘요. 쓴 카드는 몇 장 뒤에 한 번 더 나오고, 알수록 본보기가 옅어져요. 복습할 게 없어요? 다음 카드를 앞당길 수 있어요.",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"카드를 좌우로 밀면 다른 카드를 고를 수 있어요. 점수는 매겨지지 않고, 건너뛴 카드는 다음에 다시 나와요.",
"⚑ Flag":"⚑ 표시",
"card:⚑ Flagged":"⚑ 표시됨",
...
"Updated.":"업데이트했어요.",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"읽기가 또렷하면 카드가 바로 나타나고, 잠시 뒤 AI 확인이 다듬어 줘요.",
  ...
  "From {0}":"{0}에서",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"멀티카드의 텍스트를 누르면 뜻을 볼 수 있어요. 「카드 만들기」를 누르면 그 텍스트로 카드가 만들어져요. 학습에서는 그 카드가 나오고 멀티카드 자체는 나오지 않아요.",
  "Language":"언어",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"멀티카드에서 만든 카드는 멀티카드 사진 전체를 자기 텍스트만 틀로 표시해 보여 주고, 뜻 아래에 그 멀티카드 이름을 알려 줘요. 이름을 탭하면 멀티카드를 찾아볼 수 있고, ← 뒤로 를 누르면 카드로 돌아와요.","Traditional":"번체자","Simplified":"간체자","Nothing could be read.":"아무것도 읽지 못했어요.","Reading the text …":"글자를 읽는 중 …",
  ...
  "Show":"보기","Online AI review":"온라인 AI 확인","AI review":"AI 확인","What is sent: a card's Chinese text, pinyin, meaning, your note and the reader's other guesses — for every new card, for every card when you tap Check-up, Translate all or Tag all, and for one card when you tap Explain under its meaning. When the reading is hard, a picture of the text goes to a provider that takes pictures — sometimes the whole photo. Without a key of its own this phone sends through the app owner's relay, which forwards to the provider and keeps only a count.":"전송되는 것: 카드의 중국어 텍스트, 병음, 뜻, 메모, 읽기가 찾아낸 다른 후보. 새 카드를 만들 때마다 전송되고, ‘점검’, ‘모든 카드를 번역’, ‘모든 카드에 태그 달기’를 누르면 모든 카드가, 뜻 아래의 ‘설명’을 누르면 그 카드 하나가 전송돼요. 읽기가 어려울 때는 글자가 담긴 사진이, 때로는 사진 전체가 이미지를 받는 제공자에게 전송돼요. 자체 키가 없는 휴대폰은 앱 소유자의 중계를 통해 보내며, 중계는 제공자에게 전달하고 횟수만 기록해요.",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"모든 카드가 최신 순으로 있어요. 사진에서 멀티카드가 생기면 카드와 멀티카드 두 탭으로 나뉘어요. 검색하고, 표시나 태그로 거르고, 누르면 테스트·편집·삭제가 있는 상세가 열려요. + 새로 만들기로 직접 카드를 만들고, 글자를 손으로 쓸 수도 있어요. 열어 둔 카드를 옆으로 밀면 목록의 다음 카드가 나와요.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"태그로 카드를 수업이나 레벨별로 묶어요. 사진으로 만든 카드에는 그게 뭔지 알려주는 태그(메뉴, 가게, 제품, 가전 등)가 붙고, 더 보기 → 학습의 ‘모든 카드에 태그 달기’로 예전 카드에도 붙일 수 있어요. 학습에서는 고른 태그의 카드가 나와요. 카드를 길게 누르면 여러 장을 골라 한 번에 지울 수 있어요. 오래된 사진은 더 보기 → 내 데이터 → 사진에서 정리해요. 카드의 별표를 누르면 표시해 둘 수 있어요. 필터에서 별표 있는 카드만 보이고, 학습에서는 기한과 상관없이 별표 카드를 모두 연습해요.",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"카드와 사진은 이 휴대폰에만 있어요. 가끔 더보기 → 내 데이터에서 내보내 두세요. AI 확인은 카드의 중국어, 병음, 뜻을 보내고, 읽기가 어려울 때는 글자가 담긴 사진을, 때로는 사진 전체를 보내요.",
...
ru:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"«Объяснить» под значением просит ИИ написать пару фраз о карточке — что говорит текст и где ты его встретишь.",
  "Show me":"Покажи",
  "Skip":"Пропустить",
  "Again":"Ещё раз",
  ...
  "Points":"Очки",
  "Handwriting":"От руки",
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"Без образца и без порядка черт: напиши иероглиф целиком, нажми «Готово», и приложение проверит. Для тех, которые ты уже знаешь.",
  "Write freehand":"Писать от руки",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"«От руки» в Ещё → Учёба убирает образец: напиши иероглиф целиком в своём порядке черт и нажми «Готово».",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"Учёба показывает карточки, которые пора повторить, затем до восьми новых. Фото — подсказка, иероглифы под ним — кнопки, а поле для письма — ответ: обведи подсвеченную черту, и поле само идёт дальше — иероглиф за иероглифом, потом к следующей карточке. Лучше всего снимаются четыре иероглифа в строке и не больше двух строк.",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Над полем для письма стоят пиньинь и значение слова, которое ты пишешь; иероглифы, пиньинь и значение всей карточки свёрнуты внизу карточки — открой их, когда нужно. Застрял на черте? «Покажи» нарисует её, «Пропустить» поставит за тебя. Написанная карточка вернётся через несколько карточек, и чем лучше ты её знаешь, тем меньше остаётся образца. Нечего повторять? Подтяни следующие карточки.",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Смахни карточку влево или вправо, чтобы выбрать другую — ничего не оценивается, а пропущенная карточка остаётся к повторению в следующий раз.",
"⚑ Flag":"⚑ Метка",
...
"Updated.":"Обновлено.",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"Если текст прочитан чётко, карточка появляется сразу, а проверка ИИ чуть позже её уточняет.",
  ...
  "From {0}":"Из {0}",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Нажми на текст в мультикарточке, чтобы посмотреть его, и нажми «Создать карточку», чтобы сделать из него карточку. «Учить» показывает карточки, а не саму мультикарточку.",
  "Language":"Язык",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Карточка, созданная из мультикарточки, показывает всё её изображение, в рамке — только свой текст, и называет мультикарточку под значением; нажми на название, чтобы посмотреть мультикарточку, а ← Назад вернёт тебя к карточке.","Traditional":"Традиционные","Simplified":"Упрощённые","Nothing could be read.":"Прочитать ничего не вышло.","Reading the text …":"Читаю текст …",
  ...
  "Show":"Список","Online AI review":"Проверка через ИИ","AI review":"Проверка ИИ","What is sent: a card's Chinese text, pinyin, meaning, your note and the reader's other guesses — for every new card, for every card when you tap Check-up, Translate all or Tag all, and for one card when you tap Explain under its meaning. When the reading is hard, a picture of the text goes to a provider that takes pictures — sometimes the whole photo. Without a key of its own this phone sends through the app owner's relay, which forwards to the provider and keeps only a count.":"Что уходит: китайский текст карточки, пиньинь, значение, твоя заметка и другие варианты чтения — с каждой новой карточки, а со всех карточек сразу, когда нажмёшь «Проверка карточек», «Перевести карточки» или «Теги для всех карточек», а одна карточка — когда нажмёшь «Объяснить» под её значением. Когда чтение даётся с трудом, картинка с текстом — а иногда и всё фото — уходит к провайдеру, который принимает картинки. Без своего ключа телефон отправляет через сервер владельца приложения: тот передаёт запрос провайдеру и хранит только счётчик.",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Все твои карточки, новые сверху. Как только фото даст мультикарточку, появятся две вкладки — «Карточки» и «Мультикарточки». Ищи по ним, фильтруй по метке или тегу, нажми на любую — откроется карточка с «Проверить», «Изменить» и «Удалить». «+ Новая» соберёт карточку вручную, вместе с нарисованным иероглифом. Сдвинь открытую карточку вбок — придёт следующая из списка.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Теги собирают карточки по курсу или уровню, а карточка с фото получает тег по тому, что на нём: «Меню», «Магазин», «Товар», «Техника» и так далее; «Ещё» → «Учёба» → «Теги для всех карточек» проставит их и старым карточкам. «Учить» показывает те теги, которые ты выберешь. Задержи палец на карточке, чтобы отметить несколько и удалить их разом; старые фото убираются в «Ещё» → «Твои данные» → «Фото». Нажми на звёздочку у карточки, чтобы отметить её, — фильтр тогда показывает только карточки со звездой, а «Учить» берёт их все, даже те, что ещё не пора.",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"Карточки и фото остаются на этом телефоне и больше нигде — время от времени делай экспорт в «Ещё» → «Твои данные». Проверка ИИ отправляет китайский текст, пиньинь и значение карточки, а когда чтение даётся с трудом — картинку с текстом, а иногда и всё фото.",
...
vi:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"Giải thích, dưới phần nghĩa, nhờ AI viết vài câu về thẻ — chữ nói gì và bạn gặp nó ở đâu.",
  ...
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"Không mẫu, không thứ tự nét: viết trọn chữ rồi chạm Xong, app sẽ kiểm tra. Dành cho những chữ bạn đã thuộc.",
  "Write freehand":"Viết tự do",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"Viết tay trong Thêm → Học sẽ bỏ mẫu đi: viết trọn chữ theo thứ tự nét của bạn rồi chạm Xong.",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"Học hiện các thẻ đến hạn, rồi tối đa tám thẻ mới. Ảnh là gợi ý, các chữ bên dưới là nút, và ô viết là câu trả lời: tô theo nét đang sáng, ô viết tự chuyển tiếp — từng chữ một, rồi sang thẻ tiếp theo. Bốn chữ một dòng và tối đa hai dòng là dễ chụp nhất.",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Phía trên ô viết là pinyin và nghĩa của từ bạn đang viết; chữ, pinyin và nghĩa của cả thẻ được gấp lại ở cuối thẻ — mở ra khi cần. Kẹt ở một nét? Chỉ cho mình sẽ vẽ nét đó, Bỏ qua sẽ điền hộ bạn. Thẻ đã viết sẽ quay lại sau vài thẻ, và càng thuộc thì mẫu càng mờ đi. Không có thẻ đến hạn? Kéo các thẻ tiếp theo lên trước.",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Vuốt thẻ sang trái hoặc phải để chọn thẻ khác — không chấm điểm gì, và thẻ bạn bỏ qua vẫn đến hạn lần sau.",
"⚑ Flag":"⚑ Đánh dấu",
...
"Updated.":"Đã cập nhật.",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"Khi đọc rõ, thẻ hiện ra ngay, và phần kiểm tra của AI sẽ chỉnh lại một lát sau.",
  ...
  "From {0}":"Từ {0}",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Chạm vào một chữ trên thẻ gộp để tra nghĩa, rồi bấm Tạo thẻ để làm thành một thẻ. Học chỉ ôn các thẻ, không ôn thẻ gộp.",
  "Language":"Ngôn ngữ",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Thẻ tạo từ thẻ gộp hiện cả ảnh của thẻ gộp với khung chỉ quanh đoạn chữ của nó, và ghi tên thẻ gộp dưới nghĩa; chạm vào tên đó để tra thẻ gộp, và ← Quay lại đưa bạn về thẻ.","Traditional":"Phồn thể","Simplified":"Giản thể","Nothing could be read.":"Không đọc được gì.","Reading the text …":"Đang đọc chữ …",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Tất cả thẻ của bạn, mới nhất lên đầu. Khi một tấm ảnh đã tạo ra thẻ gộp, hai tab sẽ tách chúng ra — Thẻ và Thẻ gộp. Tìm kiếm, lọc theo đánh dấu hay nhãn, chạm một thẻ để xem chi tiết với Kiểm tra, Sửa và Xóa. + Mới cho bạn tự làm một thẻ, vẽ chữ luôn cũng được. Đẩy thẻ đang mở sang ngang để xem thẻ tiếp theo trong danh sách.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Nhãn giúp gom thẻ theo lớp học hay theo trình độ, và thẻ làm từ ảnh được gắn sẵn một nhãn cho biết nó là gì — Thực đơn, Cửa hàng, Sản phẩm, Thiết bị và tương tự; Thêm → Học tập → Gắn nhãn mọi thẻ sẽ gắn cho cả những thẻ cũ. Tab Học chỉ đưa ra thẻ thuộc các nhãn bạn chọn. Nhấn giữ một thẻ để đánh dấu nhiều thẻ rồi xóa cùng lúc; ảnh cũ được dọn trong Thêm → Dữ liệu của bạn → Ảnh. Chạm vào ngôi sao trên một thẻ để đánh dấu thẻ đó — bộ lọc khi ấy chỉ hiện thẻ có sao, và Học sẽ học tất cả, đến hạn hay chưa.",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"Thẻ và ảnh ở lại trên máy này chứ không đi đâu cả — thỉnh thoảng nhớ xuất chúng ra ở Thêm → Dữ liệu của bạn. Phần kiểm tra bằng AI gửi đi chữ Hán, pinyin và nghĩa của thẻ, còn khi chữ khó đọc thì gửi thêm ảnh phần chữ — đôi khi là cả tấm ảnh.",
...
th:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"ปุ่มอธิบายใต้ความหมายจะให้ AI เขียนสองสามประโยคเกี่ยวกับการ์ด — ข้อความบอกอะไรและพบได้ที่ไหน",
  "Show me":"ดูวิธี",
  "Skip":"ข้าม",
  "Again":"อีกครั้ง",
  ...
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"ไม่มีแบบและไม่มีลำดับเส้น เขียนตัวอักษรทั้งตัวแล้วแตะเสร็จ แอปจะตรวจให้ เหมาะกับตัวที่จำได้แล้ว",
  "Write freehand":"เขียนอิสระ",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"เขียนด้วยมือใน เพิ่มเติม → เรียน จะเอาแบบออก เขียนตัวอักษรทั้งตัวตามลำดับเส้นของคุณเองแล้วแตะเสร็จ",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"เรียนจะแสดงการ์ดที่ถึงกำหนดก่อน แล้วตามด้วยการ์ดใหม่สูงสุดแปดใบ รูปคือคำใบ้ ตัวอักษรด้านล่างคือปุ่ม และแผ่นเขียนคือคำตอบ: ลากตามเส้นที่สว่าง แผ่นเขียนจะไปต่อเอง ทีละตัว แล้วไปการ์ดถัดไป สี่ตัวต่อบรรทัดและไม่เกินสองบรรทัดถ่ายได้สวยที่สุด",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"เหนือแผ่นเขียนจะแสดงพินอินและความหมายของคำที่กำลังเขียน ส่วนตัวอักษร พินอิน และความหมายของทั้งการ์ดพับอยู่ท้ายการ์ด เปิดดูเมื่อต้องการ ติดที่เส้นไหน? ดูวิธี จะวาดให้ดู ข้าม จะเติมให้แทน การ์ดที่เขียนแล้วจะกลับมาอีกครั้งในอีกไม่กี่การ์ด และยิ่งจำได้ แบบก็ยิ่งจางลง ไม่มีการ์ดถึงกำหนด? ดึงการ์ดถัดไปมาก่อนได้",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"ปัดการ์ดไปซ้ายหรือขวาเพื่อเลือกใบอื่น ไม่มีการให้คะแนน และการ์ดที่ข้ามไปจะยังถึงกำหนดในครั้งหน้า",
"⚑ Flag":"⚑ ติดธง",
...
"Updated.":"อัปเดตแล้ว",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"ถ้าอ่านได้ชัด การ์ดจะโผล่ขึ้นทันที แล้ว AI จะตรวจและปรับให้อีกครู่หนึ่ง",
  ...
  "From {0}":"จาก {0}",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"แตะข้อความบนการ์ดรวมเพื่อดูความหมาย แล้วกดสร้างการ์ดเพื่อทำเป็นการ์ด โหมดเรียนจะทบทวนการ์ด ไม่ใช่การ์ดรวม",
  "Language":"ภาษา",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"การ์ดที่สร้างจากการ์ดรวมจะแสดงรูปทั้งรูปของการ์ดรวม โดยมีกรอบเฉพาะข้อความของตัวเอง และบอกชื่อการ์ดรวมไว้ใต้ความหมาย แตะชื่อนั้นเพื่อดูการ์ดรวม แล้ว ← กลับ จะพากลับมาที่การ์ด","Traditional":"ตัวเต็ม","Simplified":"ตัวย่อ","Nothing could be read.":"อ่านอะไรไม่ได้เลย","Reading the text …":"กำลังอ่านตัวอักษร …",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"การ์ดทั้งหมดของคุณ เรียงใหม่สุดก่อน พอมีรูปที่สร้างการ์ดรวมแล้ว จะแยกเป็นสองแท็บ คือ การ์ด กับ การ์ดรวม ค้นหาได้ กรองตามธงหรือแท็กได้ แตะการ์ดเพื่อดูรายละเอียดพร้อมปุ่มทดสอบ แก้ไข และลบ ปุ่ม + ใหม่ ใช้สร้างการ์ดเอง จะเขียนตัวอักษรเองก็ได้ ปัดการ์ดที่เปิดอยู่ไปด้านข้างเพื่อดูการ์ดถัดไปในรายการ",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"แท็กใช้จัดกลุ่มการ์ดตามคลาสหรือระดับ และการ์ดที่มาจากรูปจะได้แท็กตามสิ่งที่อยู่ในรูป — เมนู ร้านค้า สินค้า เครื่องใช้ไฟฟ้า และอื่นๆ ส่วนการ์ดเก่าใช้ อื่นๆ → การเรียน → ติดแท็กการ์ดทั้งหมด ได้ แท็บเรียนจะแสดงเฉพาะการ์ดในแท็กที่คุณเลือก กดค้างที่การ์ดเพื่อเลือกหลายใบแล้วลบพร้อมกัน รูปเก่าๆ ลบได้ที่ อื่นๆ → ข้อมูลของคุณ → รูปภาพ แตะดาวบนการ์ดเพื่อทำเครื่องหมายไว้ ตัวกรองจะแสดงเฉพาะการ์ดที่ติดดาว และแท็บเรียนจะเรียนการ์ดติดดาวทั้งหมด ไม่ว่าจะถึงกำหนดหรือยัง",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"การ์ดและรูปอยู่ในเครื่องนี้ที่เดียว ไม่ไปไหน — ส่งออกเก็บไว้บ้างที่ อื่นๆ → ข้อมูลของคุณ ตอนที่ AI ตรวจ จะส่งภาษาจีน พินอิน และความหมายของการ์ด และตอนที่อ่านได้ไม่ดี ก็จะส่งรูปของข้อความไปด้วย — บางครั้งก็เป็นรูปทั้งใบ",
...
id:{
  ...
  "Explain under the meaning asks the AI for a few sentences about the card — what the text says and where you meet it.":"Jelaskan di bawah arti meminta AI menulis beberapa kalimat tentang kartu ini — apa yang dikatakan teks dan di mana kamu menemuinya.",
  "Show me":"Tunjukkan",
  "Skip":"Lewati",
  "Again":"Lagi",
  ...
  "No template and no stroke order: write the whole character, then tap Done and the app checks it. For characters you already know.":"Tanpa contoh dan tanpa urutan goresan: tulis karakter utuh, ketuk Selesai, dan aplikasi memeriksanya. Untuk karakter yang sudah kamu kuasai.",
  "Write freehand":"Tulis bebas",
  "Handwriting under More → Learning takes the template away: write the whole character in your own stroke order and tap Done.":"Tulis tangan di Lainnya → Belajar menghilangkan contoh: tulis karakter utuh dengan urutan goresanmu sendiri lalu ketuk Selesai.",
  "Your cards":"Kartumu",
  "The app":"Aplikasi",
  ...
  "Learn shows the cards that are due, then up to eight new ones. The photo is the cue, the characters under it are the buttons, and the write pad is the answer: trace the lit stroke, and the pad moves on by itself — character by character, then to the next card. Four characters a line and two lines photograph best.":"Belajar menampilkan kartu yang jatuh tempo, lalu sampai delapan kartu baru. Fotonya petunjuk, karakter di bawahnya tombol, dan papan tulisnya jawaban: ikuti goresan yang menyala, dan papannya lanjut sendiri — karakter demi karakter, lalu ke kartu berikutnya. Empat karakter per baris dan dua baris paling enak difoto.",
  "Above the pad, the word you are writing shows its pinyin and meaning; the whole card's characters, pinyin and meaning sit folded at the foot of the card — open them when you need them. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Di atas papan tulis, kata yang sedang kamu tulis menampilkan pinyin dan artinya; aksara, pinyin, dan arti seluruh kartu terlipat di bagian bawah kartu — buka saat perlu. Macet di satu goresan? Tunjukkan menggambarkannya, Lewati mengisinya untukmu. Kartu yang sudah ditulis muncul sekali lagi beberapa kartu kemudian, dengan polanya makin pudar setiap kali kamu sudah hafal. Tidak ada yang jatuh tempo? Tarik kartu berikutnya lebih dulu.",
  "Swipe the card left or right to pick another one — nothing is graded, and a card you skip stays due for next time.":"Geser kartu ke kiri atau kanan untuk memilih yang lain — tidak ada yang dinilai, dan kartu yang kamu lewati tetap jatuh tempo lain kali.",
"⚑ Flag":"⚑ Tandai",
...
"Updated.":"Diperbarui.",
  ...
  "When the reading is clear, the card shows at once, and the AI's check refines it a moment later.":"Kalau bacaannya jelas, kartu langsung muncul, dan pemeriksaan AI merapikannya sesaat kemudian.",
  ...
  "From {0}":"Dari {0}",
  "Tap a text on a multicard to look it up, and press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Ketuk teks di multikartu untuk melihat artinya, lalu tekan Buat kartu untuk menjadikannya kartu. Belajar melatih kartu, bukan multikartunya.",
  "Language":"Bahasa",
  ...
  "A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Kartu yang dibuat dari multikartu menampilkan seluruh gambar multikartu dengan bingkai hanya di teksnya sendiri, dan menyebut multikartu itu di bawah arti; ketuk nama itu untuk melihat multikartu, dan ← Kembali membawamu kembali ke kartu.","Traditional":"Tradisional","Simplified":"Sederhana","Nothing could be read.":"Tidak ada yang bisa dibaca.","Reading the text …":"Membaca teks …",
  ...
  "Show":"Lihat","Online AI review":"Pemeriksaan AI online","AI review":"Pemeriksaan AI","What is sent: a card's Chinese text, pinyin, meaning, your note and the reader's other guesses — for every new card, for every card when you tap Check-up, Translate all or Tag all, and for one card when you tap Explain under its meaning. When the reading is hard, a picture of the text goes to a provider that takes pictures — sometimes the whole photo. Without a key of its own this phone sends through the app owner's relay, which forwards to the provider and keeps only a count.":"Yang dikirim: teks Mandarin, pinyin, arti sebuah kartu, catatanmu dan tebakan lain dari pembacaan aplikasi — untuk setiap kartu baru, dan untuk semua kartumu kalau kamu ketuk Cek berkala, Terjemahkan atau Beri tag semua kartu, dan untuk satu kartu kalau kamu ketuk Jelaskan di bawah artinya. Kalau teksnya susah dibaca, gambarnya dikirim ke penyedia yang menerima gambar — kadang seluruh fotonya. Tanpa kunci sendiri, ponsel ini mengirim lewat relay pemilik aplikasi, yang meneruskannya ke penyedia dan hanya menyimpan hitungannya.",
  ...
  "All your cards, newest first. Once a photo has made a multicard, two tabs split them — Cards and Multicards. Search them, filter by flag or tag, tap one for its detail with Test, Edit and Delete. + New makes a card by hand, drawn character included. Push an open card sideways for the next one in the list.":"Semua kartumu, yang terbaru di atas. Begitu sebuah foto menghasilkan multikartu, ada dua tab — Kartu dan Multikartu. Cari, filter lewat tanda atau tag, ketuk satu untuk melihat detailnya dengan Tes, Edit dan Hapus. Tombol + Baru membuat kartu sendiri, lengkap dengan karakter yang kamu gambar. Geser kartu yang terbuka ke samping untuk kartu berikutnya di daftar.",
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together; old photos are cleared out under More → Your data → Photos. Tap the star on a card to mark it as one you care about — the filter then shows them alone, and Learn studies all of them, due or not.":"Tag mengelompokkan kartu untuk sebuah kelas atau tingkat, dan kartu dari foto langsung dapat satu sesuai isinya — Menu, Toko, Produk, Elektronik dan seterusnya; Lainnya → Belajar → Beri tag semua kartu memberi tag juga ke kartu lama. Tab Belajar menampilkan tag yang kamu pilih. Tekan lama sebuah kartu untuk menandai beberapa dan menghapusnya sekaligus; foto lama dibereskan di Lainnya → Data kamu → Foto. Ketuk bintang pada sebuah kartu untuk menandainya — filter lalu hanya menampilkan kartu berbintang kamu, dan Belajar melatih semuanya, jatuh tempo atau belum.",
  ...
  "Cards and photos stay on this phone and nowhere else — export them under More → Your data now and then. The AI check sends a card's Chinese text, pinyin and meaning, and, when the reading is hard, a picture of the text — sometimes the whole photo.":"Kartu dan foto tetap di ponsel ini dan tidak di tempat lain — sesekali ekspor lewat Lainnya → Datamu. Pemeriksaan AI mengirim teks Mandarin, pinyin dan arti sebuah kartu, dan, kalau teksnya susah dibaca, gambarnya juga — kadang seluruh fotonya.",
