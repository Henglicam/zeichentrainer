...
"Updated.":"Aktualisiert.",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Ein Foto, aus dem mehrere Karten wurden, rahmt jeden seiner Texte ein — tipp einen an für Zeichen, Pinyin und Bedeutung, und bewerte ihn gleich dort.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"Ein Foto mit mehreren Texten – ein App-Bildschirm, ein Bedienfeld, eine Speisekarte – wird zu einer Karte für das ganze Bild mit einem Rahmen um jeden Text: eine Kachel unter Karten, und Lernen geht seine Texte einen nach dem anderen durch.",
...
"Updated.":"Mis à jour.",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Une photo qui a donné plusieurs cartes encadre chacun de ses textes — touche-en un pour ses caractères, son pinyin et son sens, et note-le sur place.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"Une photo avec plusieurs textes — un écran d'appli, un panneau de commande, un menu — devient une seule carte pour toute l'image, avec un cadre autour de chaque texte : une vignette sous Cartes, et Apprendre passe ses textes un par un.",
...
"Updated.":"Actualizado.",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Una foto de la que salieron varias tarjetas enmarca cada uno de sus textos — toca uno para ver sus caracteres, pinyin y significado, y califícalo ahí mismo.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"Una foto con varios textos — una pantalla de app, un panel de mandos, una carta de menú — se convierte en una sola tarjeta para toda la imagen, con un marco alrededor de cada texto: una miniatura en Tarjetas, y Aprender repasa sus textos uno por uno.",
...
"Updated.":"アップデートしました。",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"複数のカードになった写真には、テキストごとに枠が付きます。タップすると漢字・ピンイン・意味が出て、その場で評価できます。",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"テキストが複数ある写真 — アプリの画面、操作パネル、メニュー — は、画像全体で1枚のカードになり、テキストごとに枠が付きます。カード一覧では1つのタイル、学習ではそのテキストを一つずつ出します。",
...
"Updated.":"업데이트했어요.",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"카드가 여러 장 만들어진 사진에는 텍스트마다 틀이 표시돼요. 하나를 탭하면 한자, 병음, 뜻이 뜨고 그 자리에서 바로 평가할 수 있어요.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"텍스트가 여러 개인 사진 — 앱 화면, 조작판, 메뉴판 — 은 사진 전체가 카드 한 장이 되고, 텍스트마다 틀이 쳐져요. 카드 목록에는 타일 하나로 들어가고, 학습에서는 그 텍스트를 하나씩 봐요.",
...
"Updated.":"Обновлено.",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"На фото, из которого вышло несколько карточек, каждый текст обведён рамкой — нажми на неё, чтобы увидеть иероглифы, пиньинь и значение, и оцени прямо там.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"Фото с несколькими текстами — экран приложения, панель управления, меню — становится одной карточкой на всё изображение, каждый текст в рамке: одна плитка в Карточках, а Учить проходит его тексты по одному.",
...
"Updated.":"Đã cập nhật.",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Ảnh nào tạo ra nhiều thẻ sẽ đóng khung từng đoạn chữ — chạm vào để xem chữ, pinyin và nghĩa, rồi chấm điểm ngay tại đó.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"Ảnh có nhiều đoạn chữ — màn hình ứng dụng, bảng điều khiển, thực đơn — thành một thẻ cho cả ảnh với một khung quanh mỗi đoạn chữ: một ô trong Thẻ, và Học sẽ lần lượt đi qua từng đoạn chữ của nó.",
...
"Updated.":"อัปเดตแล้ว",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"รูปที่ทำการ์ดได้หลายใบจะมีกรอบล้อมข้อความแต่ละจุด แตะดูตัวอักษร พินอิน และความหมาย แล้วให้คะแนนตรงนั้นได้เลย",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"รูปที่มีข้อความหลายจุด — หน้าจอแอป แผงควบคุม เมนู — จะกลายเป็นการ์ดใบเดียวสำหรับทั้งรูป มีกรอบล้อมข้อความแต่ละจุด เป็นหนึ่งช่องในการ์ด และการเรียนจะพาไปทีละข้อความ",
...
"Updated.":"Diperbarui.",
  ...
  "A photo that made several cards frames each of its texts — tap one for its characters, pinyin and meaning, and grade it right there.":"Foto yang menghasilkan beberapa kartu memberi bingkai pada setiap teks — ketuk satu untuk melihat karakter, pinyin, dan artinya, lalu nilai langsung di situ.",
  "A photo with several texts — an app screen, a control panel, a menu board — becomes one card for the whole picture with a frame around every text: one tile under Cards, and Learn goes through its texts one by one.":"Foto dengan beberapa teks — layar aplikasi, panel kontrol, daftar menu — menjadi satu kartu untuk seluruh gambar dengan bingkai di setiap teks: satu petak di Kartu, dan Belajar melewati teksnya satu per satu.",
