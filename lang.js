...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Bewerte dich selbst: Schwer, Mittel, Leicht. Die Karte kommt früher oder später wieder, das ist der ganze Trick. Nichts fällig? Zieh die nächsten Karten vor.",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"Tags gruppieren Karten für einen Kurs oder ein Niveau, und eine Karte aus einem Foto bekommt eins dafür, was sie ist — Speisekarte, Laden, Produkt, Gerät und so weiter; unter Mehr → Lernen gibt „Alle Karten taggen“ auch den älteren Karten eins. Lernen zeigt die Tags, die du wählst. Halte eine Karte gedrückt, um mehrere zu markieren und zusammen zu löschen — ein Foto im Kamera-Tab genauso. Tippe auf den Stern einer Karte, um sie dir zu merken — der Filter zeigt dann nur deine Karten mit Stern, beim Lernen genauso.",
...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Note-toi : Difficile, Moyen, Facile. La carte revient plus ou moins tôt, c'est toute l'astuce. Rien à revoir ? Avance les prochaines cartes.",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"Les tags regroupent les cartes pour un cours ou un niveau, et une carte issue d'une photo en reçoit un pour ce qu'elle est — Menu, Boutique, Produit, Appareil, etc. ; dans Plus → Apprendre, « Taguer toutes les cartes » en donne un aussi aux anciennes. Apprendre montre les tags que tu choisis. Appuie longuement sur une carte pour en marquer plusieurs et les supprimer ensemble — pareil pour une photo dans l'onglet Appareil photo. Touche l'étoile d'une carte pour la garder à l'œil — le filtre n'affiche alors que tes cartes avec étoile, et Apprendre ne travaille qu'avec elles.",
...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Puntúate: Difícil, Medio, Fácil. La tarjeta vuelve antes o después, ese es todo el truco. ¿Nada pendiente? Adelanta las siguientes tarjetas.",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"Las etiquetas agrupan tarjetas por clase o nivel, y una tarjeta hecha con una foto recibe una según lo que sea — Menú, Tienda, Producto, Aparato y demás; en Más → Aprender, «Etiquetar todas las tarjetas» también se la da a las antiguas. Aprender muestra las etiquetas que elijas. Mantén pulsada una tarjeta para marcar varias y borrarlas juntas — una foto en la pestaña Cámara igual. Toca la estrella de una tarjeta para marcarla — el filtro muestra entonces solo tus tarjetas con estrella, y Aprender practica solo esas.",
...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"自分で評価します：難しい、普通、簡単。カードは早めか遅めにまた出てきます。それだけの仕組みです。復習がない日は次のカードを前倒しできます。",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"タグでカードを授業やレベルごとにまとめられます。写真から作ったカードには、その中身を表すタグ（メニュー、店、商品、家電など）が付き、その他 → 学習の「すべてのカードにタグを付ける」で古いカードにも付けられます。学習では選んだタグのカードが出ます。カードを長押しすると複数を選んでまとめて削除できます。カメラタブの写真も同じです。 カードの星をタップすると印を付けられます。フィルターでは星付きのカードだけが表示され、学習でも星付きだけを練習できます。",
...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"스스로 평가해요: 어려움, 보통, 쉬움. 카드는 빨리 또는 늦게 다시 나와요. 그게 전부예요. 복습할 게 없으면 다음 카드를 앞당겨요.",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"태그로 카드를 수업이나 레벨별로 묶어요. 사진으로 만든 카드에는 그게 뭔지 알려주는 태그(메뉴, 가게, 제품, 가전 등)가 붙고, 더 보기 → 학습의 ‘모든 카드에 태그 달기’로 예전 카드에도 붙일 수 있어요. 학습에서는 고른 태그의 카드가 나와요. 카드를 길게 누르면 여러 장을 골라 한 번에 지울 수 있어요. 카메라 탭의 사진도 같아요. 카드의 별표를 누르면 표시해 둘 수 있어요. 필터에서 별표 있는 카드만 보거나 학습할 수 있어요.",
...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Оцени себя сам: «Трудно», «Средне», «Легко». Карточка вернётся раньше или позже — в этом весь фокус. Ничего не ждёт? Возьми следующие карточки заранее.",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"Теги собирают карточки по курсу или уровню, а карточка с фото получает тег по тому, что на нём: «Меню», «Магазин», «Товар», «Техника» и так далее; «Ещё» → «Учёба» → «Теги для всех карточек» проставит их и старым карточкам. «Учить» показывает те теги, которые ты выберешь. Задержи палец на карточке, чтобы отметить несколько и удалить их разом — с фото во вкладке «Камера» точно так же. Нажми на звёздочку у карточки, чтобы отметить её, — фильтр тогда показывает только карточки со звездой, и «Учить» берёт только их.",
...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Tự chấm điểm: Khó, Vừa, Dễ. Thẻ sẽ quay lại sớm hay muộn tùy vào đó, cả bí quyết nằm ở chỗ này. Không có thẻ nào đến hạn? Kéo các thẻ tiếp theo lên học trước.",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"Nhãn giúp gom thẻ theo lớp học hay theo trình độ, và thẻ làm từ ảnh được gắn sẵn một nhãn cho biết nó là gì — Thực đơn, Cửa hàng, Sản phẩm, Thiết bị và tương tự; Thêm → Học tập → Gắn nhãn mọi thẻ sẽ gắn cho cả những thẻ cũ. Tab Học chỉ đưa ra thẻ thuộc các nhãn bạn chọn. Nhấn giữ một thẻ để đánh dấu nhiều thẻ rồi xóa cùng lúc — ảnh ở tab Máy ảnh cũng vậy. Chạm vào ngôi sao trên một thẻ để đánh dấu thẻ đó — bộ lọc khi ấy chỉ hiện, và chỉ cho học, những thẻ có sao.",
...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"ให้คะแนนตัวเอง: ยาก ปานกลาง ง่าย การ์ดจะกลับมาเร็วหรือช้าตามนั้น เคล็ดลับมีแค่นี้ วันไหนไม่มีการ์ดถึงกำหนด ก็ดึงการ์ดถัดไปมาก่อนได้",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"แท็กใช้จัดกลุ่มการ์ดตามคลาสหรือระดับ และการ์ดที่มาจากรูปจะได้แท็กตามสิ่งที่อยู่ในรูป — เมนู ร้านค้า สินค้า เครื่องใช้ไฟฟ้า และอื่นๆ ส่วนการ์ดเก่าใช้ อื่นๆ → การเรียน → ติดแท็กการ์ดทั้งหมด ได้ แท็บเรียนจะแสดงเฉพาะการ์ดในแท็กที่คุณเลือก กดค้างที่การ์ดเพื่อเลือกหลายใบแล้วลบพร้อมกัน รูปในแท็บกล้องก็ทำแบบเดียวกัน แตะดาวบนการ์ดเพื่อทำเครื่องหมายไว้ ตัวกรองจะแสดงเฉพาะการ์ดที่ติดดาว และแท็บเรียนก็จะเรียนเฉพาะการ์ดเหล่านั้น",
...
"Grade yourself: Hard, Medium, Easy. The card comes back sooner or later, that is the whole trick. Nothing due? Pull the next cards forward.":"Nilai dirimu sendiri: Sulit, Sedang, Mudah. Kartunya balik lagi lebih cepat atau lebih lama, itu saja rahasianya. Tidak ada yang perlu diulang? Majukan kartu berikutnya.",
  ...
  "Tags group cards for a class or a level, and a card from a photo gets one for what it is — Menu, Shop, Product, Appliance and so on; More → Learning → Tag all cards gives the older cards one too. Learn shows the tags you pick. Press and hold a card to mark several and delete them together — a photo in the Camera tab the same way. Tap the star on a card to mark it as one you care about — the filter then shows, or studies, your starred cards alone.":"Tag mengelompokkan kartu untuk sebuah kelas atau tingkat, dan kartu dari foto langsung dapat satu sesuai isinya — Menu, Toko, Produk, Elektronik dan seterusnya; Lainnya → Belajar → Beri tag semua kartu memberi tag juga ke kartu lama. Tab Belajar menampilkan tag yang kamu pilih. Tekan lama sebuah kartu untuk menandai beberapa dan menghapusnya sekaligus — foto di tab Kamera juga begitu. Ketuk bintang pada sebuah kartu untuk menandainya — filter lalu hanya menampilkan, dan hanya melatih, kartu berbintang kamu.",
