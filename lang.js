/* 识字 Shízì — the app's own texts in other languages (v253, H: "Multi language UI and translations").
...
"Updated.":"Aktualisiert.",
  ...
  "the reading looks wrong":"die Lesung scheint falsch","the pinyin does not match the dictionary ({0}) — check it":"das Pinyin passt nicht zum Wörterbuch ({0}) – prüf es nach","the AI is not sure: {0}":"die KI ist sich nicht sicher: {0}",
  ...
  "Test this card":"Diese Karte testen","Edit":"Bearbeiten","Delete card":"Karte löschen","Add a text":"Text hinzufügen",
  ...
  "Import":"Importieren","A shizi-….json.txt file. Existing cards are overwritten.":"Eine Datei shizi-….json.txt. Vorhandene Karten werden überschrieben.",
  ...
  "“{0}” is already in the deck.":"„{0}“ ist schon im Stapel.","“{0}” added.":"„{0}“ angelegt.","Export failed: {0}":"Export fehlgeschlagen: {0}","Not a 识字 export (JSON).":"Kein 识字-Export (JSON).",
...
"Updated.":"Mis à jour.",
  ...
  "the reading looks wrong":"la lecture semble fausse","the pinyin does not match the dictionary ({0}) — check it":"le pinyin ne correspond pas au dictionnaire ({0}) — vérifie-le","the AI is not sure: {0}":"l’IA n’est pas sûre : {0}",
  ...
  "Test this card":"Tester cette carte","Edit":"Modifier","Delete card":"Supprimer la carte","Add a text":"Ajouter un texte",
  ...
  "Import":"Importer","A shizi-….json.txt file. Existing cards are overwritten.":"Un fichier shizi-….json.txt. Les cartes existantes sont remplacées.",
  ...
  "“{0}” is already in the deck.":"« {0} » est déjà dans le paquet.","“{0}” added.":"« {0} » ajouté.","Export failed: {0}":"Échec de l'export : {0}","Not a 识字 export (JSON).":"Ce n'est pas un export 识字 (JSON).",
...
"Updated.":"Actualizado.",
  ...
  "the reading looks wrong":"la lectura parece incorrecta","the pinyin does not match the dictionary ({0}) — check it":"el pinyin no coincide con el diccionario ({0}) — revísalo","the AI is not sure: {0}":"la IA no está segura: {0}",
  ...
  "Test this card":"Probar esta tarjeta","Edit":"Editar","Delete card":"Eliminar tarjeta","Add a text":"Añadir un texto",
  ...
  "Import":"Importar","A shizi-….json.txt file. Existing cards are overwritten.":"Un archivo shizi-….json.txt. Las tarjetas existentes se sobrescriben.",
  ...
  "“{0}” is already in the deck.":"«{0}» ya está en el mazo.","“{0}” added.":"«{0}» añadida.","Export failed: {0}":"Error al exportar: {0}","Not a 识字 export (JSON).":"No es una exportación de 识字 (JSON).",
...
"Updated.":"アップデートしました。",
  ...
  "the reading looks wrong":"読み取りが誤りのようです","the pinyin does not match the dictionary ({0}) — check it":"ピンインが辞書と合いません（{0}）— 確かめてみて","the AI is not sure: {0}":"AIは自信がありません：{0}",
  "time":"{0}回","times":"{0}回",
  ...
  "Test this card":"このカードをテスト","Edit":"編集","Delete card":"カードを削除","Add a text":"テキストを追加",
  ...
  "Import":"インポート","A shizi-….json.txt file. Existing cards are overwritten.":"shizi-….json.txt ファイル。既存のカードは上書きされます。",
  ...
  "“{0}” is already in the deck.":"「{0}」はすでにあります。","“{0}” added.":"「{0}」を追加しました。","Export failed: {0}":"エクスポートに失敗しました：{0}","Not a 识字 export (JSON).":"识字のエクスポート（JSON）ではありません。",
...
"Updated.":"업데이트했어요.",
  ...
  "the reading looks wrong":"읽기가 틀린 것 같아요","the pinyin does not match the dictionary ({0}) — check it":"병음이 사전과 맞지 않아요 ({0}) — 확인해 봐요","the AI is not sure: {0}":"AI가 확신하지 못해요: {0}",
  "time":"{0}번","times":"{0}번",
  ...
  "Test this card":"이 카드 테스트","Edit":"편집","Delete card":"카드 삭제","Add a text":"텍스트 추가",
  "Delete":"삭제","Cancel":"취소",
  ...
  "Import":"가져오기","A shizi-….json.txt file. Existing cards are overwritten.":"shizi-….json.txt 파일. 기존 카드는 덮어써요.",
  ...
  "“{0}” is already in the deck.":"“{0}”은(는) 이미 있어요.","“{0}” added.":"“{0}” 추가됨.","Export failed: {0}":"내보내기 실패: {0}","Not a 识字 export (JSON).":"识字 내보내기 파일(JSON)이 아니에요.",
...
"Updated.":"Обновлено.",
  ...
  "the reading looks wrong":"текст прочитан неверно","the pinyin does not match the dictionary ({0}) — check it":"пиньинь не совпадает со словарём ({0}) — проверь","the AI is not sure: {0}":"ИИ не уверен: {0}",
  ...
  "Test this card":"Проверить эту карточку","Edit":"Изменить","Delete card":"Удалить карточку","Add a text":"Добавить текст",
  ...
  "Import":"Импорт","A shizi-….json.txt file. Existing cards are overwritten.":"Файл shizi-….json.txt. Существующие карточки перезапишутся.",
  ...
  "“{0}” is already in the deck.":"«{0}» уже есть в колоде.","“{0}” added.":"«{0}» добавлено.","Export failed: {0}":"Экспорт не удался: {0}","Not a 识字 export (JSON).":"Это не экспорт 识字 (JSON).",
...
"Updated.":"Đã cập nhật.",
  ...
  "the reading looks wrong":"bản đọc có vẻ sai","the pinyin does not match the dictionary ({0}) — check it":"pinyin không khớp với từ điển ({0}) — kiểm tra lại nhé","the AI is not sure: {0}":"AI không chắc: {0}",
  ...
  "Test this card":"Kiểm tra thẻ này","Edit":"Sửa","Delete card":"Xóa thẻ","Add a text":"Thêm chữ",
  ...
  "Import":"Nhập","A shizi-….json.txt file. Existing cards are overwritten.":"Một tệp shizi-….json.txt. Thẻ đang có sẽ bị ghi đè.",
  ...
  "“{0}” is already in the deck.":"“{0}” đã có trong bộ thẻ rồi.","“{0}” added.":"Đã thêm “{0}”.","Export failed: {0}":"Xuất không được: {0}","Not a 识字 export (JSON).":"Đây không phải tệp xuất của 识字 (JSON).",
...
"Updated.":"อัปเดตแล้ว",
  ...
  "the reading looks wrong":"การอ่านดูผิด","the pinyin does not match the dictionary ({0}) — check it":"พินอินไม่ตรงกับพจนานุกรม ({0}) ลองตรวจดู","the AI is not sure: {0}":"AI ไม่แน่ใจ: {0}",
  ...
  "Test this card":"ทดสอบการ์ดนี้","Edit":"แก้ไข","Delete card":"ลบการ์ด","Add a text":"เพิ่มข้อความ",
  ...
  "Import":"นำเข้า","A shizi-….json.txt file. Existing cards are overwritten.":"ไฟล์ shizi-….json.txt การ์ดที่มีอยู่จะถูกเขียนทับ",
  ...
  "“{0}” is already in the deck.":"“{0}” มีอยู่แล้ว","“{0}” added.":"เพิ่ม “{0}” แล้ว","Export failed: {0}":"ส่งออกไม่สำเร็จ: {0}","Not a 识字 export (JSON).":"ไม่ใช่ไฟล์ส่งออกของ 识字 (JSON)",
...
"Updated.":"Diperbarui.",
  ...
  "the reading looks wrong":"hasil bacanya kelihatan salah","the pinyin does not match the dictionary ({0}) — check it":"pinyin-nya tidak cocok dengan kamus ({0}) — cek lagi ya","the AI is not sure: {0}":"AI tidak yakin: {0}",
  ...
  "Test this card":"Tes kartu ini","Edit":"Edit","Delete card":"Hapus kartu","Add a text":"Tambah teks",
  ...
  "Import":"Impor","A shizi-….json.txt file. Existing cards are overwritten.":"Berkas shizi-….json.txt. Kartu yang sudah ada akan ditimpa.",
  ...
  "“{0}” is already in the deck.":"“{0}” sudah ada di kartumu.","“{0}” added.":"“{0}” ditambahkan.","Export failed: {0}":"Ekspor gagal: {0}","Not a 识字 export (JSON).":"Ini bukan berkas ekspor 识字 (JSON).",
