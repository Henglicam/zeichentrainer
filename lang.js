...
"Updated.":"Aktualisiert.",
  ...
  "Got it":"Kann ich",
  "From {0}":"Aus {0}",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Tippe auf einen Text in einer Multicard und stimme ab — rot für noch nicht, grün für kann ich — oder mach mit „Karte erstellen“ eine Karte daraus. Lernen übt die Karten, nie die Multicard selbst.",
  "Language":"Sprache",
...
"Updated.":"Mis à jour.",
  ...
  "Got it":"Acquis",
  "From {0}":"De {0}",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Touche un texte d’une multicarte pour voter — rouge pour pas encore, vert pour acquis — ou appuie sur « Créer une carte » pour en faire une carte. Apprendre travaille les cartes, jamais la multicarte elle-même.",
  "Language":"Langue",
...
"Updated.":"Actualizado.",
  ...
  "Got it":"Ya lo sé",
  "From {0}":"De {0}",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Toca un texto de una multitarjeta para votar — rojo si todavía no, verde si ya lo sabes — o pulsa «Crear tarjeta» para convertirlo en tarjeta. Aprender practica las tarjetas, nunca la multitarjeta.",
  "Language":"Idioma",
...
"Updated.":"アップデートしました。",
  ...
  "Got it":"覚えた",
  "From {0}":"{0} から",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"マルチカードの文字をタップして、まだか覚えたかを選べます。「カードを作る」を押すと、その文字からカードができます。学習で出てくるのはそのカードで、マルチカード自体は出てきません。",
  "Language":"言語",
...
"Updated.":"업데이트했어요.",
  ...
  "Got it":"알아요",
  "From {0}":"{0}에서",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"멀티카드의 텍스트를 누르면 아직인지 알아요인지 고를 수 있어요. 「카드 만들기」를 누르면 그 텍스트로 카드가 만들어져요. 학습에서는 그 카드가 나오고 멀티카드 자체는 나오지 않아요.",
  "Language":"언어",
...
"Updated.":"Обновлено.",
  ...
  "Got it":"Знаю",
  "From {0}":"Из {0}",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Нажми на текст в мультикарточке и отметь — красным «ещё нет», зелёным «знаю» — или нажми «Создать карточку», чтобы сделать из него карточку. «Учить» показывает карточки, а не саму мультикарточку.",
  "Language":"Язык",
...
"Updated.":"Đã cập nhật.",
  ...
  "Got it":"Thuộc rồi",
  "From {0}":"Từ {0}",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Chạm vào một chữ trên thẻ gộp để đánh dấu — đỏ là chưa thuộc, xanh là thuộc rồi — hoặc bấm Tạo thẻ để làm thành một thẻ. Học chỉ ôn các thẻ, không ôn thẻ gộp.",
  "Language":"Ngôn ngữ",
...
"Updated.":"อัปเดตแล้ว",
  ...
  "Got it":"จำได้",
  "From {0}":"จาก {0}",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"แตะข้อความบนการ์ดรวมเพื่อเลือกว่ายังไม่ได้หรือจำได้ หรือกดสร้างการ์ดเพื่อทำเป็นการ์ด โหมดเรียนจะทบทวนการ์ด ไม่ใช่การ์ดรวม",
  "Language":"ภาษา",
...
"Updated.":"Diperbarui.",
  ...
  "Got it":"Sudah bisa",
  "From {0}":"Dari {0}",
  "Tap a text on a multicard to vote — red for not yet, green for got it — or press Generate flashcard to make a card of it. Learn studies the flashcards, never the multicard itself.":"Ketuk teks di multikartu untuk menilai — merah kalau belum, hijau kalau sudah bisa — atau tekan Buat kartu untuk menjadikannya kartu. Belajar melatih kartu, bukan multikartunya.",
  "Language":"Bahasa",
