...
"Updated.":"Aktualisiert.",
  ...
  "Page":"Seite",", or the photo for the text alone":", oder das Foto für den Text allein","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"Eine Karte von einem Bildschirm oder einem Bedienfeld zeigt das ganze Bild mit einem Punkt an jedem Text, ihr eigener leuchtet, und ist als Seite markiert.","Traditional":"Langzeichen","Simplified":"Kurzzeichen","Nothing could be read.":"Es konnte nichts gelesen werden.","Reading the text …":"Text wird gelesen …",
...
"Updated.":"Mis à jour.",
  ...
  "Page":"Page",", or the photo for the text alone":", ou la photo pour le texte seul","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"Une carte issue d'un écran ou d'un panneau montre l'image entière avec un point sur chaque texte, le sien allumé, et porte la marque Page.","Traditional":"Traditionnel","Simplified":"Simplifié","Nothing could be read.":"Rien n'a pu être lu.","Reading the text …":"Lecture du texte …",
...
"Updated.":"Actualizado.",
  ...
  "Page":"Página",", or the photo for the text alone":", o la foto para ver solo el texto","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"Una tarjeta de una pantalla o un panel muestra la imagen entera con un punto en cada texto, el suyo encendido, y lleva la marca Página.","Traditional":"Tradicional","Simplified":"Simplificado","Nothing could be read.":"No se pudo leer nada.","Reading the text …":"Leyendo el texto …",
...
"Updated.":"アップデートしました。",
  ...
  "Page":"ページ",", or the photo for the text alone":"、写真をタップするとこの文字だけを表示","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"画面や操作パネルからのカードは、テキストごとに点が付いた画像全体を表示し、自分の点が光ります。「ページ」の印付きです。","Traditional":"繁体字","Simplified":"簡体字","Nothing could be read.":"何も読み取れませんでした。","Reading the text …":"文字を読み取り中 …",
...
"Updated.":"업데이트했어요.",
  ...
  "Page":"페이지",", or the photo for the text alone":", 사진을 탭하면 이 글자만 크게","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"화면이나 조작판에서 만든 카드는 텍스트마다 점이 찍힌 사진 전체를 보여 주고, 자기 점은 빛나요. 「페이지」 표시가 붙어요.","Traditional":"번체자","Simplified":"간체자","Nothing could be read.":"아무것도 읽지 못했어요.","Reading the text …":"글자를 읽는 중 …",
...
"Updated.":"Обновлено.",
  ...
  "Page":"Страница",", or the photo for the text alone":", или на фото — чтобы увидеть только этот текст","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"Карточка с экрана или панели показывает всё изображение с точкой у каждого текста, своя точка светится, и помечена как Страница.","Traditional":"Традиционные","Simplified":"Упрощённые","Nothing could be read.":"Прочитать ничего не вышло.","Reading the text …":"Читаю текст …",
...
"Updated.":"Đã cập nhật.",
  ...
  "Page":"Trang",", or the photo for the text alone":", hoặc chạm vào ảnh để xem riêng đoạn chữ này","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"Thẻ từ một màn hình hay bảng điều khiển hiện cả ảnh với một chấm ở mỗi đoạn chữ, chấm của nó sáng lên, và được đánh dấu là Trang.","Traditional":"Phồn thể","Simplified":"Giản thể","Nothing could be read.":"Không đọc được gì.","Reading the text …":"Đang đọc chữ …",
...
"Updated.":"อัปเดตแล้ว",
  ...
  "Page":"หน้า",", or the photo for the text alone":" หรือแตะรูปเพื่อดูเฉพาะข้อความนี้","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"การ์ดจากหน้าจอหรือแผงควบคุมจะแสดงรูปทั้งรูป มีจุดที่ข้อความแต่ละจุด จุดของตัวเองจะสว่าง และมีป้ายว่า หน้า","Traditional":"ตัวเต็ม","Simplified":"ตัวย่อ","Nothing could be read.":"อ่านอะไรไม่ได้เลย","Reading the text …":"กำลังอ่านตัวอักษร …",
...
"Updated.":"Diperbarui.",
  ...
  "Page":"Halaman",", or the photo for the text alone":", atau foto untuk melihat teksnya saja","A card from a screen or a panel shows the whole picture with a dot on every text, its own dot lit, and is marked Page.":"Kartu dari layar atau panel menampilkan seluruh gambar dengan titik di setiap teks, titiknya sendiri menyala, dan ditandai Halaman.","Traditional":"Tradisional","Simplified":"Sederhana","Nothing could be read.":"Tidak ada yang bisa dibaca.","Reading the text …":"Membaca teks …",
