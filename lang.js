/* 识字 Zeichentrainer — the app's own texts in other languages (v253, H: "Multi language UI and translations").
   ...
   PLURAL when its count words have more than the two forms English has (v401, Russian). */
const LANGS=[["en","English"],["de","Deutsch"],["fr","Français"],["es","Español"],["ja","日本語"],["ko","한국어"],["ru","Русский"]];
const LANG_LOCALE={en:"en-GB",de:"de-DE",fr:"fr-FR",es:"es-ES",ja:"ja-JP",ko:"ko-KR",ru:"ru-RU"};
const LANG_NAME={en:"English",de:"German",fr:"French",es:"Spanish",ja:"Japanese",ko:"Korean",ru:"Russian"}; /* the languages' English names, for the AI's prompt (v256) — a language missing here would get an English meaning from the model, so this list moves with LANGS */
let LANG="en";
