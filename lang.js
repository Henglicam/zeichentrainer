...
de:{
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Pinyin und Bedeutung liegen eingeklappt unter den Knöpfen; klapp sie auf, wenn du sie brauchst, oder schreib die ganze Karte, dann öffnen sie sich von selbst. Hängst du an einem Strich? Zeig mir malt ihn vor, Überspringen setzt ihn für dich. Eine geschriebene Karte kommt ein paar Karten später noch einmal, und je besser du sie kannst, desto weniger Vorlage bleibt. Nichts fällig? Hol die nächsten Karten vor.",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"Wisch die Karte nach links oder rechts oder tipp auf die Pfeile neben dem Schreibfeld, um eine andere zu wählen – nichts wird bewertet, und eine übersprungene Karte bleibt fürs nächste Mal fällig.",
"⚑ Flag":"⚑ Markieren",
...
"Updated.":"Aktualisiert.",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"Ein Foto, aus dem mehrere Karten wurden, behält jede davon an ihrem Platz — tipp einen Text an für Zeichen, Pinyin und Bedeutung, und bewerte ihn gleich dort.",
  ...
  ", or the photo for the whole picture":", oder auf das Foto für das ganze Bild",
  ...
  ", or the photo for the text alone":", oder auf das Foto für den Text allein","A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Eine Karte, die aus einer Multicard erstellt wurde, zeigt das ganze Bild der Multicard mit einem Rahmen nur um ihren eigenen Text und nennt die Multicard unter der Bedeutung; tipp auf den Namen, um die Multicard nachzuschlagen, und ← Zurück bringt dich zur Karte zurück.","Traditional":"Langzeichen","Simplified":"Kurzzeichen","Nothing could be read.":"Es konnte nichts gelesen werden.","Reading the text …":"Text wird gelesen …",
...
fr:{
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Le pinyin et le sens sont repliés sous les boutons ; ouvre-les quand tu en as besoin, ou écris toute la carte et ils s'ouvrent tout seuls. Bloqué sur un trait ? Montre-moi le dessine, Passer le pose pour toi. Une carte écrite revient quelques cartes plus loin, avec de moins en moins de modèle à mesure que tu la connais. Rien à revoir ? Avance les prochaines cartes.",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"Balaie la carte vers la gauche ou la droite, ou touche les flèches à côté du carré, pour en choisir une autre — rien n'est noté, et une carte sautée reste à revoir la prochaine fois.",
"⚑ Flag":"⚑ Signaler",
...
"Updated.":"Mis à jour.",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"Une photo qui a donné plusieurs cartes garde chacune à sa place — touche un texte pour ses caractères, son pinyin et son sens, et note-le sur place.",
  ...
  ", or the photo for the whole picture":", ou la photo pour l'image entière",
...
es:{
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"El pinyin y el significado están plegados bajo los botones; ábrelos cuando los necesites, o escribe toda la tarjeta y se abren solos. ¿Atascado en un trazo? Muéstrame lo dibuja, Saltar lo pone por ti. Una tarjeta escrita vuelve unas tarjetas después, con menos plantilla cuanto mejor la sabes. ¿Nada pendiente? Adelanta las siguientes tarjetas.",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"Desliza la tarjeta a izquierda o derecha, o toca las flechas junto al cuadro, para elegir otra: no se puntúa nada, y una tarjeta que saltes sigue pendiente para la próxima vez.",
"⚑ Flag":"⚑ Marcar",
...
"Updated.":"Actualizado.",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"Una foto de la que salieron varias tarjetas guarda cada una en su sitio — toca un texto para ver sus caracteres, pinyin y significado, y califícalo ahí mismo.",
  ...
  ", or the photo for the whole picture":", o la foto para ver la imagen entera",
...
ja:{
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"ピンインと意味はボタンの下にたたまれています。必要なときに開くか、カードを全部書けば自動で開きます。画に詰まったら「見せて」でお手本が動き、「スキップ」で代わりに書いてくれます。書いたカードは数枚あとにもう一度出て、覚えるほどお手本が薄くなります。復習がない？次のカードを前倒しできます。",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"カードを左右にスワイプするか、書き取り枠の横の矢印をタップすると別のカードを選べます。採点はされず、飛ばしたカードは次回また出てきます。",
"⚑ Flag":"⚑ 印をつける",
"card:⚑ Flagged":"⚑ 印あり",
...
"Updated.":"アップデートしました。",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"複数のカードになった写真は、それぞれの場所をそのまま覚えています。テキストをタップすると漢字・ピンイン・意味が出て、その場で評価できます。",
  ...
  ", or the photo for the whole picture":"。写真をタップすると全体が見られます",
  ...
  ", or the photo for the text alone":"。写真をタップするとこの文字だけが見られます","A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"マルチカードから作ったカードは、マルチカードの画像全体を自分のテキストだけ枠で囲んで表示し、意味の下にそのマルチカードの名前を示します。名前をタップするとマルチカードを調べられて、← 戻る でカードに戻れます。","Traditional":"繁体字","Simplified":"簡体字","Nothing could be read.":"何も読み取れませんでした。","Reading the text …":"文字を読み取り中 …",
...
ko:{
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"병음과 뜻은 버튼 아래에 접혀 있어요. 필요할 때 열거나, 카드를 다 쓰면 저절로 열려요. 획에서 막히면 보여줘가 그려 주고, 건너뛰기가 대신 채워 줘요. 쓴 카드는 몇 장 뒤에 한 번 더 나오고, 알수록 본보기가 옅어져요. 복습할 게 없어요? 다음 카드를 앞당길 수 있어요.",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"카드를 좌우로 밀거나 쓰기판 옆 화살표를 누르면 다른 카드를 고를 수 있어요. 채점은 없고, 건너뛴 카드는 다음에 다시 나와요.",
"⚑ Flag":"⚑ 표시",
"card:⚑ Flagged":"⚑ 표시됨",
...
"Updated.":"업데이트했어요.",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"카드가 여러 장 만들어진 사진은 각 카드의 자리를 그대로 기억해요. 텍스트를 탭하면 한자, 병음, 뜻이 뜨고 그 자리에서 바로 평가할 수 있어요.",
  ...
  ", or the photo for the whole picture":". 사진을 누르면 전체 사진이 보여요",
  ...
  ", or the photo for the text alone":". 사진을 누르면 이 글자만 보여요","A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"멀티카드에서 만든 카드는 멀티카드 사진 전체를 자기 텍스트만 틀로 표시해 보여 주고, 뜻 아래에 그 멀티카드 이름을 알려 줘요. 이름을 탭하면 멀티카드를 찾아볼 수 있고, ← 뒤로 를 누르면 카드로 돌아와요.","Traditional":"번체자","Simplified":"간체자","Nothing could be read.":"아무것도 읽지 못했어요.","Reading the text …":"글자를 읽는 중 …",
  ...
  "Show":"보기","Online AI review":"온라인 AI 확인","AI review":"AI 확인","What is sent: a card's Chinese text, pinyin, meaning, your note and the reader's other guesses — for every new card, and for every card when you tap Check-up, Translate all or Tag all. When the reading is hard, a picture of the text goes to a provider that takes pictures — sometimes the whole photo. Without a key of its own this phone sends through the app owner's relay, which forwards to the provider and keeps only a count.":"전송되는 것: 카드의 중국어 텍스트, 병음, 뜻, 메모, 읽기가 찾아낸 다른 후보. 새 카드를 만들 때마다 전송되고, ‘점검’, ‘모든 카드를 번역’, ‘모든 카드에 태그 달기’를 누르면 모든 카드가 전송돼요. 읽기가 어려울 때는 글자가 담긴 사진이, 때로는 사진 전체가 이미지를 받는 제공자에게 전송돼요. 자체 키가 없는 휴대폰은 앱 소유자의 중계를 통해 보내며, 중계는 제공자에게 전달하고 횟수만 기록해요.",
...
ru:{
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Пиньинь и значение свёрнуты под кнопками: открой их, когда нужно, или напиши всю карточку — тогда они откроются сами. Застрял на черте? «Покажи» нарисует её, «Пропустить» поставит за тебя. Написанная карточка вернётся через несколько карточек, и чем лучше ты её знаешь, тем меньше остаётся образца. Нечего повторять? Подтяни следующие карточки.",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"Проведи по карточке влево или вправо или нажми стрелки рядом с полем, чтобы выбрать другую — ничего не оценивается, а пропущенная карточка остаётся на следующий раз.",
"⚑ Flag":"⚑ Метка",
...
"Updated.":"Обновлено.",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"Фото, из которого вышло несколько карточек, помнит место каждой — нажми на текст, чтобы увидеть иероглифы, пиньинь и значение, и оцени прямо там.",
  ...
  ", or the photo for the whole picture":", или на фото, чтобы увидеть его целиком",
  ...
  ", or the photo for the text alone":", или на фото — чтобы увидеть только этот текст","A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Карточка, созданная из мультикарточки, показывает всё её изображение, в рамке — только свой текст, и называет мультикарточку под значением; нажми на название, чтобы посмотреть мультикарточку, а ← Назад вернёт тебя к карточке.","Traditional":"Традиционные","Simplified":"Упрощённые","Nothing could be read.":"Прочитать ничего не вышло.","Reading the text …":"Читаю текст …",
  ...
  "Show":"Список","Online AI review":"Проверка через ИИ","AI review":"Проверка ИИ","What is sent: a card's Chinese text, pinyin, meaning, your note and the reader's other guesses — for every new card, and for every card when you tap Check-up, Translate all or Tag all. When the reading is hard, a picture of the text goes to a provider that takes pictures — sometimes the whole photo. Without a key of its own this phone sends through the app owner's relay, which forwards to the provider and keeps only a count.":"Что уходит: китайский текст карточки, пиньинь, значение, твоя заметка и другие варианты чтения — с каждой новой карточки, а со всех карточек сразу, когда нажмёшь «Проверка карточек», «Перевести карточки» или «Теги для всех карточек». Когда чтение даётся с трудом, картинка с текстом — а иногда и всё фото — уходит к провайдеру, который принимает картинки. Без своего ключа телефон отправляет через сервер владельца приложения: тот передаёт запрос провайдеру и хранит только счётчик.",
...
vi:{
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Pinyin và nghĩa được gấp lại dưới các nút; mở ra khi cần, hoặc viết hết thẻ là chúng tự mở. Kẹt ở một nét? Chỉ cho mình sẽ vẽ nét đó, Bỏ qua sẽ điền hộ bạn. Thẻ đã viết sẽ quay lại sau vài thẻ, và càng thuộc thì mẫu càng mờ đi. Không có thẻ đến hạn? Kéo các thẻ tiếp theo lên trước.",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"Vuốt thẻ sang trái hoặc phải, hoặc chạm mũi tên cạnh ô viết, để chọn thẻ khác — không chấm điểm gì, và thẻ bạn bỏ qua vẫn đến hạn lần sau.",
"⚑ Flag":"⚑ Đánh dấu",
...
"Updated.":"Đã cập nhật.",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"Ảnh nào tạo ra nhiều thẻ vẫn giữ nguyên chỗ của từng thẻ — chạm vào một đoạn chữ để xem chữ, pinyin và nghĩa, rồi chấm điểm ngay tại đó.",
  ...
  ", or the photo for the whole picture":", chạm vào ảnh để xem cả tấm",
  ...
  ", or the photo for the text alone":", hoặc chạm vào ảnh để xem riêng đoạn chữ này","A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Thẻ tạo từ thẻ gộp hiện cả ảnh của thẻ gộp với khung chỉ quanh đoạn chữ của nó, và ghi tên thẻ gộp dưới nghĩa; chạm vào tên đó để tra thẻ gộp, và ← Quay lại đưa bạn về thẻ.","Traditional":"Phồn thể","Simplified":"Giản thể","Nothing could be read.":"Không đọc được gì.","Reading the text …":"Đang đọc chữ …",
...
th:{
  ...
  "Skip":"ข้าม",
  "Again":"อีกครั้ง",
  "Previous card":"การ์ดก่อนหน้า",
  "Next card":"การ์ดถัดไป",
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"พินอินและความหมายพับอยู่ใต้ปุ่ม เปิดดูเมื่อต้องการ หรือเขียนทั้งการ์ดให้ครบแล้วมันจะเปิดเอง ติดที่เส้นไหน? ดูวิธี จะวาดให้ดู ข้าม จะเติมให้แทน การ์ดที่เขียนแล้วจะกลับมาอีกครั้งในอีกไม่กี่การ์ด และยิ่งจำได้ แบบก็ยิ่งจางลง ไม่มีการ์ดถึงกำหนด? ดึงการ์ดถัดไปมาก่อนได้",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"ปัดการ์ดไปซ้ายหรือขวา หรือแตะลูกศรข้างแผ่นเขียน เพื่อเลือกการ์ดอื่น — ไม่มีการให้คะแนน และการ์ดที่ข้ามไปยังคงถึงกำหนดในครั้งถัดไป",
"⚑ Flag":"⚑ ติดธง",
...
"Updated.":"อัปเดตแล้ว",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"รูปที่ทำการ์ดได้หลายใบยังจำตำแหน่งของแต่ละใบไว้ แตะที่ข้อความเพื่อดูตัวอักษร พินอิน และความหมาย แล้วให้คะแนนตรงนั้นได้เลย",
  ...
  ", or the photo for the whole picture":" หรือแตะรูปเพื่อดูทั้งใบ",
  ...
  ", or the photo for the text alone":" หรือแตะรูปเพื่อดูเฉพาะข้อความนี้","A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"การ์ดที่สร้างจากการ์ดรวมจะแสดงรูปทั้งรูปของการ์ดรวม โดยมีกรอบเฉพาะข้อความของตัวเอง และบอกชื่อการ์ดรวมไว้ใต้ความหมาย แตะชื่อนั้นเพื่อดูการ์ดรวม แล้ว ← กลับ จะพากลับมาที่การ์ด","Traditional":"ตัวเต็ม","Simplified":"ตัวย่อ","Nothing could be read.":"อ่านอะไรไม่ได้เลย","Reading the text …":"กำลังอ่านตัวอักษร …",
...
id:{
  ...
  "Pinyin and meaning sit folded under the buttons; open them when you need them, or write the whole card and they open by themselves. Stuck on a stroke? Show me draws it, Skip fills it in for you. A card you wrote comes round once more a few cards later, with less of the template each time you know it. Nothing due? Pull the next cards forward.":"Pinyin dan arti terlipat di bawah tombol; buka saat perlu, atau tulis seluruh kartu dan keduanya terbuka sendiri. Macet di satu goresan? Tunjukkan menggambarkannya, Lewati mengisinya untukmu. Kartu yang sudah ditulis muncul sekali lagi beberapa kartu kemudian, dengan polanya makin pudar setiap kali kamu sudah hafal. Tidak ada yang jatuh tempo? Tarik kartu berikutnya lebih dulu.",
  "Swipe the card left or right, or tap the arrows beside the pad, to pick another one — nothing is graded, and a card you skip stays due for next time.":"Geser kartu ke kiri atau kanan, atau ketuk panah di samping papan, untuk memilih kartu lain — tidak ada yang dinilai, dan kartu yang kamu lewati tetap jatuh tempo lain kali.",
"⚑ Flag":"⚑ Tandai",
...
"Updated.":"Diperbarui.",
  ...
  "A photo that made several cards keeps every one of them in its place — tap a text on it for its characters, pinyin and meaning, and grade it right there.":"Foto yang menghasilkan beberapa kartu menyimpan tempat masing-masing — ketuk sebuah teks untuk melihat karakter, pinyin, dan artinya, lalu nilai langsung di situ.",
  ...
  ", or the photo for the whole picture":", atau fotonya untuk melihat gambar utuh",
  ...
  ", or the photo for the text alone":", atau foto untuk melihat teksnya saja","A card made from a multicard shows the multicard's whole picture with a frame around its own text, and names the multicard under the meaning; tap that name to look the multicard up, and ← Back brings you back to the card.":"Kartu yang dibuat dari multikartu menampilkan seluruh gambar multikartu dengan bingkai hanya di teksnya sendiri, dan menyebut multikartu itu di bawah arti; ketuk nama itu untuk melihat multikartu, dan ← Kembali membawamu kembali ke kartu.","Traditional":"Tradisional","Simplified":"Sederhana","Nothing could be read.":"Tidak ada yang bisa dibaca.","Reading the text …":"Membaca teks …",
