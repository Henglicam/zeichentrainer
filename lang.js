...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"Hängst du fest? „Zeig mir“ malt den Strich, „Überspringen“ setzt das Zeichen ein. Die ganze Karte steht offen an ihrem Fuß – tippe auf die Zeile, um sie zuzuklappen. Wisch zur Seite für eine andere Karte — durchs Wischen wird nichts bewertet.",
...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"Bloqué ? « Montre-moi » trace le trait et « Passer » remplit le caractère. Toute la carte est ouverte en bas — touche cette ligne pour la replier. Balaie sur le côté pour choisir une autre carte — balayer ne note rien.",
...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"¿Atascado? «Muéstrame» dibuja el trazo y «Saltar» completa el carácter. La tarjeta entera está abierta al pie: toca esa fila para plegarla. Desliza a los lados para elegir otra tarjeta — deslizar no puntúa nada.",
...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"手が止まったら、「見せて」が画を描き、「スキップ」が文字を埋めます。カード全体はいちばん下に開いたまま出ています。その行をタップするとたためます。横にスワイプすれば別のカードを選べます。スワイプでは何も採点されません。",
...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"막혔나요? 보여줘가 획을 그려 주고, 건너뛰기가 글자를 채워 줘요. 카드 전체는 맨 아래에 펼쳐져 있어요. 그 줄을 탭하면 접혀요. 옆으로 밀면 다른 카드를 고를 수 있고, 미는 것으로는 아무것도 채점되지 않아요.",
...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"Застрял? «Покажи» нарисует черту, «Пропустить» впишет иероглиф. Вся карточка развёрнута внизу — нажми на эту строку, чтобы свернуть её. Смахни вбок, чтобы выбрать другую карточку — смахивание ничего не оценивает.",
...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"Bí à? Chỉ cho mình sẽ vẽ nét, Bỏ qua sẽ điền chữ. Cả thẻ mở sẵn ở dưới cùng — chạm vào dòng đó để gấp lại. Vuốt sang ngang để chọn thẻ khác — vuốt không chấm điểm gì cả.",
...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"ติดตรงไหน กดดูวิธีให้วาดเส้นให้ หรือกดข้ามให้เติมตัวนั้นให้ ทั้งการ์ดกางอยู่ด้านล่าง แตะแถวนั้นเพื่อพับเก็บ ปัดซ้ายขวาเพื่อเลือกการ์ดอื่น การปัดไม่นับคะแนนอะไร",
...
,
  ...
  "Stuck? Show me draws the stroke and Skip fills the character in. The whole card stands open at its foot — tap that row to fold it away. Swipe sideways to pick another card — nothing is graded by swiping.":"Buntu? Tunjukkan menggambar garisnya dan Lewati mengisi karakternya. Seluruh kartu terbuka di bagian bawah — ketuk baris itu untuk melipatnya. Geser ke samping untuk memilih kartu lain — menggeser tidak menilai apa pun.",
