...
const ASSETS = [
  ...
  /* the guide's five figures, light and dark (v598) — real crops of the app, 84 KB of WebP in all. They are shell
     assets, not vendor ones: the guide is a screen a learner opens offline, and a figure that 404s there is worse
     than no figure. Regenerated by tools/guide-shots.js when a layout changes. */
