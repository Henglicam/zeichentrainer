...
const ASSETS = [
  ...
  /* the guide's five figures, light and dark (v598), and the two sample cards (v599) — real crops of the app,
     113 KB of WebP in all. They are shell assets, not vendor ones: the guide is a screen a learner opens offline,
     and a figure that 404s there is worse than no figure; `front` is on the Learn tab's very first screen, which a
     fresh install shows before anything else. Regenerated by tools/guide-shots.js when a layout changes. */
  "./guide/photo-light.webp", "./guide/photo-dark.webp", "./guide/chars-light.webp", "./guide/chars-dark.webp",
  "./guide/learn-light.webp", "./guide/learn-dark.webp", "./guide/cards-light.webp", "./guide/cards-dark.webp",
  "./guide/lang-light.webp", "./guide/lang-dark.webp",
  "./guide/front-light.webp", "./guide/front-dark.webp", "./guide/pcard-light.webp", "./guide/pcard-dark.webp"
];
